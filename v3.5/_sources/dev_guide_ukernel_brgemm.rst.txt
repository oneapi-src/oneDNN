...
Because of hardware restrictions, the BRGeMM ukernel requires a specific data layout.

The :ref:`dnnl_brgemm_pack_b_need_pack <doxid-group__dnnl__api__ukernel__brgemm_1ga42adc7638688ad9c03e851b554129227>` method can be called to determine if packing is necessary. If so, :ref:`packB ukernel <doxid-dev_guide_ukernel_transform>` shall be created to do the actual packing.
