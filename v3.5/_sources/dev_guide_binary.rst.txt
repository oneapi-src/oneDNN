...
The source and destination tensors may have ``f32``, ``bf16``, ``f16``, ``s32`` or ``s8/u8`` data types. The binary primitive supports the following combinations of data types:
