...
The packB ukernel allows users to pack BRGeMM B matrices in an optimal layout before executing the :ref:`BRGeMM ukernel <doxid-dev_guide_ukernel_brgemm>`. This is an out-of-place operation.
...
* Source leading dimension should be greater or equal to N to return the correct result.
