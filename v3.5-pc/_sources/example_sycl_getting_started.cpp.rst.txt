.. index:: pair: example; sycl_getting_started.cpp
.. _doxid-sycl_getting_started_8cpp-example:

sycl_getting_started.cpp
========================

This is an example to demonstrate how to build a simple graph and run on SYCL device. Annotated version: :ref:`Getting started with SYCL extensions API and Graph API <doxid-graph_sycl_getting_started_cpp>`
