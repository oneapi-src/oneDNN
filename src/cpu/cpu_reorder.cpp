...
const impl_list_map_t comp_s8s8_impl_list_map {
    ...
    {{f32, s8, 3}, {
        ...
        REG_SR(f32, oiw, s8, OIw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oiw, s8, OIw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wio, s8, OIw4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wio, s8, OIw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wio, s8, OIw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        ...
        REG_SR(f32, oiw, s8, Owi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wio, s8, Owi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oiw, s8, OwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wio, s8, OwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oiw, s8, OIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wio, s8, OIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
    ...
    {{f32, s8, 4}, {
        ...
        REG_SR(f32, oihw, s8, OIhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oihw, s8, OIhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, hwio, s8, OIhw4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, hwio, s8, OIhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, hwio, s8, OIhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        ...
        REG_SR(f32, goiw, s8, gOwi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wigo, s8, gOwi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, goiw, s8, gOwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wigo, s8, gOwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, goiw, s8, gOIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, wigo, s8, gOIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oihw, s8, Owhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, hwio, s8, Owhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oihw, s8, OhwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, hwio, s8, OhwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oihw, s8, OIhw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, hwio, s8, OIhw16i16o4i, fmt_order::keep, spec::conv_req_comp),
    ...
    {{f32, s8, 5}, {
        ...
        REG_SR(f32, oidhw, s8, OIdhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, oidhw, s8, OIdhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, dhwio, s8, OIdhw4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, dhwio, s8, OIdhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, dhwio, s8, OIdhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        ...
        REG_SR(f32, goihw, s8, gOwhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, hwigo, s8, gOwhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(f32, goihw, s8, gOhwI16o4i, fmt_order::keep, spec::conv_req_comp),
    ...
    // bf16 -> s8
    {{bf16, s8, 2}, {
        REG_SR(bf16, oi, s8, OI4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, io, s8, OI4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oi, s8, OI4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, io, s8, OI4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oi, s8, OI4i64o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, io, s8, OI4i64o4i, fmt_order::keep, spec::conv_req_comp),
    ...
    {{bf16, s8, 3}, {
        ...
        REG_SR(bf16, oiw, s8, OIw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oiw, s8, OIw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wio, s8, OIw4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wio, s8, OIw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wio, s8, OIw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        ...
        REG_SR(bf16, oiw, s8, Owi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wio, s8, Owi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oiw, s8, OwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wio, s8, OwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oiw, s8, OIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wio, s8, OIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
    ...
    {{bf16, s8, 4}, {
        ...
        REG_SR(bf16, oihw, s8, OIhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oihw, s8, OIhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwio, s8, OIhw4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwio, s8, OIhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwio, s8, OIhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        ...
        REG_SR(bf16, goiw, s8, gOwi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wigo, s8, gOwi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, goiw, s8, gOwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wigo, s8, gOwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, goiw, s8, gOIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, wigo, s8, gOIw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oihw, s8, Owhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwio, s8, Owhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oihw, s8, OhwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwio, s8, OhwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oihw, s8, OIhw16i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwio, s8, OIhw16i16o4i, fmt_order::keep, spec::conv_req_comp),
    ...
    {{bf16, s8, 5}, {
        ...
        REG_SR(bf16, oidhw, s8, OIdhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, oidhw, s8, OIdhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, dhwio, s8, OIdhw4i16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, dhwio, s8, OIdhw4i32o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, dhwio, s8, OIdhw4i64o4i, fmt_order::keep, spec::conv_req_comp),
        ...
        REG_SR(bf16, goihw, s8, gOwhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwigo, s8, gOwhi16o, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, goihw, s8, gOhwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, hwigo, s8, gOhwI16o4i, fmt_order::keep, spec::conv_req_comp),
        REG_SR(bf16, goihw, s8, gOIhw16i16o4i, fmt_order::keep, spec::conv_req_comp),
