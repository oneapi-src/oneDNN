...
static const rpd_create_f cpu_reorder_impl_list[] = {
    ...
    simple_reorder_t<f32, Oidhw16o, f32, Odhwi16o, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, Oidhw16o, f32, Odhwi16o, fmt_order::reverse>::pd_t::create,
    ...
    simple_reorder_t<f32, gOidhw16o, f32, gOdhwi16o, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, gOidhw16o, f32, gOdhwi16o, fmt_order::reverse>::pd_t::create,
    ...
    simple_reorder_t<f32, goihw, f32, Goihw8g, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, Goihw8g, fmt_order::reverse>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, Goihw16g, fmt_order::keep>::pd_t::create,
