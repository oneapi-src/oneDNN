...
#include "reference_convolution_relu.hpp"
...
status_t reference_convolution_relu<prec>::execute_forward() {
    ...
    const memory_desc_wrapper
        src_d(this->_crpd.src_primitive_desc.memory_desc),
        weights_d(this->_crpd.weights_primitive_desc.memory_desc),
...
template <impl::precision_t prec>
status_t reference_convolution_relu<prec>::constraint(
...
template <impl::precision_t prec>
const primitive_impl reference_convolution_relu<prec>::implementation = {
    reference_convolution_relu<prec>::create
};

template class reference_convolution_relu<precision::f32>;
