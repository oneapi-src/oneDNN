...
class jit_avx2_kernel_b0_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_b0_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_b0_gemm_s8u8s32_kern();
};

class jit_avx2_kernel_b0_c_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_b0_c_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_b0_c_gemm_s8u8s32_kern();
};

class jit_avx2_kernel_b0_r_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_b0_r_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_b0_r_gemm_s8u8s32_kern();
};

class jit_avx2_kernel_b0_b_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_b0_b_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_b0_b_gemm_s8u8s32_kern();
};

class jit_avx2_kernel_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_gemm_s8u8s32_kern();
};

class jit_avx2_kernel_c_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_c_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_c_gemm_s8u8s32_kern();
};

class jit_avx2_kernel_r_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_r_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_r_gemm_s8u8s32_kern();
};

class jit_avx2_kernel_b_gemm_s8u8s32_kern : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx2_kernel_b_gemm_s8u8s32_kern);

public:
    jit_avx2_kernel_b_gemm_s8u8s32_kern();
};
