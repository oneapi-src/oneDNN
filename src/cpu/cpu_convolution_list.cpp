...
const std::map<conv_impl_key_t, std::vector<impl_list_item_t>> impl_list_map {
    ...
    {{forward, f32, f32, f32}, {
        ...
        REG_CONV_P_FWD(CPU_INSTANCE(gemm_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE(ref_convolution_fwd_t))
    ...
    {{forward, bf16, bf16, f32}, {
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brdgmm_dw_convolution_fwd_t))
        REG_CONV_P_FWD(REG_IP_P_FWD(CPU_INSTANCE_X64(ip_convolution_fwd_t)))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brgemm_1x1_convolution_fwd_t<avx512_core_bf16_amx_bf16>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brgemm_convolution_fwd_t<avx512_core_bf16_amx_bf16>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_amx_1x1_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_amx_convolution_fwd_t))
    ...
    {{backward_data, f32, f32, f32}, {
        ...
        REG_CONV_P_BWD_D(CPU_INSTANCE(gemm_convolution_bwd_data_t))
        REG_CONV_P_BWD_D(CPU_INSTANCE(ref_convolution_bwd_data_t))
        nullptr,
    }},
    ...
    {{backward_weights, f32, f32, f32}, {
        REG_CONV_P_BWD_W(REG_IP_P_BWD(CPU_INSTANCE_X64(ip_convolution_bwd_weights_t)))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_common_dw_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_common_1x1_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_core_f32_wino_conv_4x3_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_common_convolution_winograd_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_common_convolution_bwd_weights_t<f32>))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx2_dw_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx2_1x1_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_sse41_dw_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx2_convolution_bwd_weights_t))
        ...
        REG_CONV_P_BWD_W(CPU_INSTANCE(gemm_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE(ref_convolution_bwd_weights_t))
        nullptr,
    }},
    {{backward_weights, bf16, f32, bf16}, {
        REG_CONV_P_BWD_W(REG_IP_P_BWD(CPU_INSTANCE_X64(ip_convolution_bwd_weights_t)))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_uni_dw_convolution_bwd_weights_t<avx512_core, bf16, f32>))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_core_amx_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_core_bf16_1x1_convolution_bwd_weights_t<f32>))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_core_bf16_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(gemm_bf16_convolution_bwd_weights_t<f32>))
        REG_CONV_P_BWD_W(CPU_INSTANCE(ref_convolution_bwd_weights_t))
        nullptr,
    }},
    {{backward_weights, bf16, bf16, bf16}, {
        REG_CONV_P_BWD_W(REG_IP_P_BWD(CPU_INSTANCE_X64(ip_convolution_bwd_weights_t)))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_uni_dw_convolution_bwd_weights_t<avx512_core, bf16, bf16>))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_core_amx_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_core_bf16_1x1_convolution_bwd_weights_t<bf16>))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(jit_avx512_core_bf16_convolution_bwd_weights_t))
        REG_CONV_P_BWD_W(CPU_INSTANCE_X64(gemm_bf16_convolution_bwd_weights_t<bf16>))
        REG_CONV_P_BWD_W(CPU_INSTANCE(ref_convolution_bwd_weights_t))
        nullptr,
    }},
    // FWD int8 (src:s8)
    {{forward, s8, s8, f32}, {
        REG_CONV_P_FWD(REG_IP_P_FWD(CPU_INSTANCE_X64(ip_convolution_fwd_t)))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brgemm_1x1_convolution_fwd_t<avx512_core_bf16_amx_int8>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_amx_1x1_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_amx_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_x8s8s32x_1x1_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_x8s8s32x_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_uni_x8s8s32x_1x1_convolution_fwd_t<avx2>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_uni_x8s8s32x_convolution_fwd_t<avx2>))
    ...
    {{forward, u8, s8, f32}, {
        ...
        REG_CONV_P_FWD(REG_IP_P_FWD(CPU_INSTANCE_X64(ip_convolution_fwd_t)))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brgemm_1x1_convolution_fwd_t<avx512_core_bf16_amx_int8>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brgemm_convolution_fwd_t<avx512_core_bf16_amx_int8>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_amx_1x1_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_amx_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brgemm_1x1_convolution_fwd_t<avx512_core_vnni>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(brgemm_convolution_fwd_t<avx512_core_vnni>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_u8s8s32x_wino_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_x8s8s32x_1x1_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_avx512_core_x8s8s32x_convolution_fwd_t))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_uni_x8s8s32x_1x1_convolution_fwd_t<avx2>))
        REG_CONV_P_FWD(CPU_INSTANCE_X64(jit_uni_x8s8s32x_convolution_fwd_t<avx2>))
    ...
    {{backward_data, f32, s8, u8}, {
        REG_CONV_P_BWD_D(CPU_INSTANCE(_gemm_u8s8s32x_convolution_bwd_data_t<f32>))
        REG_CONV_P_BWD_D(CPU_INSTANCE(ref_convolution_int8_bwd_data_t))
        nullptr,
    }},
    {{backward_data, s32, s8, u8}, {
        REG_CONV_P_BWD_D(CPU_INSTANCE(_gemm_u8s8s32x_convolution_bwd_data_t<s32>))
        REG_CONV_P_BWD_D(CPU_INSTANCE(ref_convolution_int8_bwd_data_t))
        nullptr,
    }},
    {{backward_data, s8, s8, u8}, {
        REG_CONV_P_BWD_D(CPU_INSTANCE(_gemm_u8s8s32x_convolution_bwd_data_t<s8>))
        REG_CONV_P_BWD_D(CPU_INSTANCE(ref_convolution_int8_bwd_data_t))
        nullptr,
    }},
    {{backward_data, u8, s8, u8}, {
        REG_CONV_P_BWD_D(CPU_INSTANCE(_gemm_u8s8s32x_convolution_bwd_data_t<u8>))
        REG_CONV_P_BWD_D(CPU_INSTANCE(ref_convolution_int8_bwd_data_t))
        nullptr,
    }},
