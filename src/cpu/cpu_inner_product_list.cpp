...
const std::map<ip_impl_key_t, std::vector<impl_list_item_t>> impl_list_map REG_IP_P({
    ...
    {{backward_data, f32, f32, f32}, {
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_data_t<avx512_core>))
        REG_BWD_PK(CPU_INSTANCE(gemm_inner_product_bwd_data_t<f32>))
        REG_BWD_PK(CPU_INSTANCE(ref_inner_product_bwd_data_t))
        nullptr,
    }},
    {{backward_data, f32, bf16, bf16}, {
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_data_t<avx512_core_bf16_amx_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_data_t<avx512_core_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(gemm_bf16_inner_product_bwd_data_t<f32>))
        REG_BWD_PK(CPU_INSTANCE(ref_inner_product_bwd_data_t))
        nullptr,
    }},
    {{backward_data, bf16, bf16, bf16}, {
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_data_t<avx512_core_bf16_amx_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_data_t<avx512_core_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(gemm_bf16_inner_product_bwd_data_t<bf16>))
        REG_BWD_PK(CPU_INSTANCE(ref_inner_product_bwd_data_t))
        nullptr,
    }},
    {{backward_weights, f32, f32, f32}, {
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_weights_t<avx512_core>))
        REG_BWD_PK(CPU_INSTANCE(gemm_inner_product_bwd_weights_t<f32>))
        REG_BWD_PK(CPU_INSTANCE(ref_inner_product_bwd_weights_t))
        nullptr,
    }},
    {{backward_weights, bf16, f32, bf16}, {
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_weights_t<avx512_core_bf16_amx_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_weights_t<avx512_core_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(gemm_bf16_inner_product_bwd_weights_t<f32>))
        REG_BWD_PK(CPU_INSTANCE(ref_inner_product_bwd_weights_t))
        nullptr,
    }},
    {{backward_weights, bf16, bf16, bf16}, {
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_weights_t<avx512_core_bf16_amx_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(brgemm_inner_product_bwd_weights_t<avx512_core_bf16>))
        REG_BWD_PK(CPU_INSTANCE_X64(gemm_bf16_inner_product_bwd_weights_t<bf16>))
        REG_BWD_PK(CPU_INSTANCE(ref_inner_product_bwd_weights_t))
        nullptr,
    }},
    {{forward, s8, s8, f32}, {
