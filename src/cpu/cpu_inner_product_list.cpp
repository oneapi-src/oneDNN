...
const pd_create_f impl_list[] = {
        ...
        /* bfloat16 */
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16, bf16, bf16, f32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16, bf16>)
        ...
        /* int */
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, u8, s8, u8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, u8, s8, s8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, u8, s8, s32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, u8, s8, f32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, s8, s8, u8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, s8, s8, s8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, s8, s8, s32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_bf16_amx_int8, s8, s8, f32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, u8, s8, u8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, u8, s8, s8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, u8, s8, s32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, u8, s8, f32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, s8, s8, u8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, s8, s8, s8>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, s8, s8, s32>)
        CPU_INSTANCE_X64(brgemm_inner_product_fwd_t<avx512_core_vnni, s8, s8, f32>)
