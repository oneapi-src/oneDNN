...
protected:
    ...
    void generate() {
        ...
        L(vector_loop_start_label);
        {
            ...
            if (is_training) uni_vmovups(wg_addr(0), G0);
            ...
            // if training we write back the gates
            if (is_training) uni_vmovups(wg_addr(1), G1);
            ...
            if (is_training) uni_vmovups(ws_h_addr, tmp1_vmm);
        ...
        L(rem_loop_start_label);
        {
            ...
            // if training we write back the gates
            if (is_training) uni_vmovss(wg_addr(0), G0s);
            ...
            // if training we write back the gates
            if (is_training) uni_vmovss(wg_addr(1), G1s);
            ...
            if (is_training) uni_vmovss(ws_h_addr, tmp1s_vmm);
