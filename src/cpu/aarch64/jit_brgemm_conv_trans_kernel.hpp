...
struct jit_sve512_core_brgemm_conv_trans_kernel_t : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_sve512_core_brgemm_conv_trans_kernel_t)
...
struct jit_sve512_core_brgemm_conv_rtus_kernel_t
    : jit_sve512_core_brgemm_conv_trans_kernel_t {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_sve512_core_brgemm_conv_rtus_kernel_t)
