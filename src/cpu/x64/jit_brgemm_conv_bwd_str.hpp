...
#ifndef CPU_X64_JIT_BRGEMM_CONV_BWD_STR_HPP
#define CPU_X64_JIT_BRGEMM_CONV_BWD_STR_HPP
...
struct brgemm_convolution_bwd_str_t : public primitive_t {
    ...
    struct pd_t : public cpu_convolution_bwd_data_pd_t {
        ...
        status_t create_primitive(
            ...
            return primitive_t::create_primitive_common<
                    brgemm_convolution_bwd_str_t, pd_t>(
                    primitive, this, engine, false, cache_blob);
        }

        const char *name() const override {
            return JIT_IMPL_NAME_HELPER("brgconv_str:", isa, "");
        }
        // ---------------------------------
    ...
    brgemm_convolution_bwd_str_t(const pd_t *apd)
        : primitive_t(apd), bias_d(pd()->weights_md(1)) {}

    ~brgemm_convolution_bwd_str_t() = default;
