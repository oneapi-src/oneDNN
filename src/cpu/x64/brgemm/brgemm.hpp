...
#include "cpu/x64/brgemm/brgemm_desc.hpp"
...
///
status_t create_brgemm_descriptor(brgemm_desc_t **brg, brgemm_batch_kind_t type,
...
/// Generates a kernel in BRGEMM descriptor
///
status_t create_brgemm_kernel(brgemm_desc_t *brg);

/// Destroys a BRGEMM descriptor
///
...
void execute_brgemm_kernel(const brgemm_desc_t *brg, int bs, const void *addr_A,
        ...
        void *ptr_C, void *scratch = nullptr);
...
///
void execute_brgemm_kernel(const brgemm_desc_t *brg, int bs, const void *addr_A,
        const void *addr_B, void *ptr_C, void *scratch = nullptr);
