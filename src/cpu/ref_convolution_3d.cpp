...
#include "ref_convolution_3d.hpp"
...
void _ref_convolution_3d_fwd_t<src_type, wei_type, dst_type, acc_type>
        ::execute_forward() {
...
void ref_convolution_3d_bwd_data_t<diff_src_type, wei_type, diff_dst_type,
                ...
                for (int id = 0; id < ID; ++id) {
                    for (int ih = 0; ih < IH; ++ih) {
                        for (int iw = 0; iw < IW; ++iw) {
                            auto ds_idx = diff_src_d.off(mb, g*IC + ic,
                                id, ih, iw);
...
template <data_type_t src_type, data_type_t diff_wei_type,
         data_type_t diff_dst_type, data_type_t acc_type>
void ref_convolution_3d_bwd_weights_t<src_type, diff_wei_type, diff_dst_type,
...
template struct _ref_convolution_3d_fwd_t<f32>;
template struct _ref_convolution_3d_fwd_t<s16, s16, s32, s32>;
template struct _ref_convolution_3d_fwd_t<u8, s8, s32, s32>;
template struct _ref_convolution_3d_fwd_t<u8, s8, s8, s32>;
template struct _ref_convolution_3d_fwd_t<u8, s8, u8, s32>;

template struct ref_convolution_3d_bwd_data_t<f32, f32, f32, f32>;
template struct ref_convolution_3d_bwd_data_t<s32, s16, s16, s32>;

template struct ref_convolution_3d_bwd_weights_t<f32, f32, f32, f32>;
template struct ref_convolution_3d_bwd_weights_t<s16, s32, s16, s32>;
