...
struct cpu_convolution_3d_fwd_pd_t: public convolution_3d_fwd_pd_t {
    using cpu_memory_pd_t = cpu_memory_t::pd_t;

    cpu_convolution_3d_fwd_pd_t(engine_t *engine,
            const convolution_desc_t *adesc,
            const primitive_attr_t *attr,
            const typename cpu_convolution_3d_fwd_pd_t::base_class *hint_fwd_pd)
        : convolution_3d_fwd_pd_t(engine, adesc, attr, hint_fwd_pd)
        , src_pd_(this->engine_, &this->desc_.src_desc)
        , dst_pd_(this->engine_, &this->desc_.dst_desc)
        , weights_pd_(this->engine_, &this->desc_.weights_desc)
        , bias_pd_(this->engine_, &this->desc_.bias_desc) {}
    virtual ~cpu_convolution_3d_fwd_pd_t() {}
...
struct cpu_convolution_3d_bwd_data_pd_t: public convolution_3d_bwd_data_pd_t {
    using cpu_memory_pd_t = cpu_memory_t::pd_t;

    cpu_convolution_3d_bwd_data_pd_t(engine_t *engine,
            const convolution_desc_t *adesc,
            const primitive_attr_t *attr,
            const convolution_3d_fwd_pd_t *hint_fwd_pd)
        : convolution_3d_bwd_data_pd_t(engine, adesc, attr, hint_fwd_pd)
        , diff_src_pd_(this->engine_, &this->desc_.diff_src_desc)
        , diff_dst_pd_(this->engine_, &this->desc_.diff_dst_desc)
        , weights_pd_(this->engine_, &this->desc_.weights_desc) {}
    virtual ~cpu_convolution_3d_bwd_data_pd_t() {}
...
struct cpu_convolution_3d_bwd_weights_pd_t: public convolution_3d_bwd_weights_pd_t {
    using cpu_memory_pd_t = cpu_memory_t::pd_t;

    cpu_convolution_3d_bwd_weights_pd_t(engine_t *engine,
            const convolution_desc_t *adesc,
            const primitive_attr_t *attr,
            const convolution_3d_fwd_pd_t *hint_fwd_pd)
        : convolution_3d_bwd_weights_pd_t(engine, adesc, attr, hint_fwd_pd)
        , src_pd_(this->engine_, &this->desc_.src_desc)
        , diff_dst_pd_(this->engine_, &this->desc_.diff_dst_desc)
        , diff_weights_pd_(this->engine_, &this->desc_.diff_weights_desc)
        , diff_bias_pd_(this->engine_, &this->desc_.diff_bias_desc) {}
    virtual ~cpu_convolution_3d_bwd_weights_pd_t() {}
