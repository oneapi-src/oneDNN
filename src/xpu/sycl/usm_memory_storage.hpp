        ...
        switch (usm_kind_) {
            case alloc::host:
                printf("USM malloc host with size %lu, total allocation "
                       "size: %f GiB\n",
                        size,
                        1.0 * (usm_mem().size() + size) / (1024 * 1024 * 1024));
