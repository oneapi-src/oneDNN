...
status_t compute_blocking(memory_desc_t &memory_desc) {
    ...
    case mkl_dnn_n_f32: return fill_n(blk, tensor);
    case mkl_dnn_nchw_f32: return fill_nchw(blk, tensor);
    case mkl_dnn_nhwc_f32: return fill_nhwc(blk, tensor);
	default: return mkl_dnn_invalid;
    }
}
