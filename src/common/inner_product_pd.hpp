...
private:
    const memory_desc_t *_src_md() const { return ip_prop_invariant_src_d(&desc_); }
    const memory_desc_t *_wei_md() const { return ip_prop_invariant_wei_d(&desc_); }
    const memory_desc_t *_bia_md() const { return ip_prop_invariant_bia_d(&desc_); }
    const memory_desc_t *_dst_md() const { return ip_prop_invariant_dst_d(&desc_); }
};
