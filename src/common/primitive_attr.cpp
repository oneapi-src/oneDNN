...
bool primitive_attr_t::has_default_values(dnnl_primitive_attr::skip_mask_t mask,
    ...
    return true
            ...
            && IMPLICATION((bool)(~mask & skip_mask_t::input_zero_points),
                    input_zero_points_.has_default_values())
            && IMPLICATION((bool)(~mask & skip_mask_t::weights_zero_points),
                    weights_zero_points_.has_default_values())
            && IMPLICATION((bool)(~mask & skip_mask_t::output_compensations),
