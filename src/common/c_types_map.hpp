...
using batch_normalization_primitive_desc_t = mkldnn_batch_normalization_primitive_desc_t;
...
union primitive_desc_t {
    ...
    batch_normalization_primitive_desc_t batch_normalization;
...
#   define DECL_CTOR_AND_CONVERTERS(c_type, name) \
    ...
    DECL_CTOR_AND_CONVERTERS(batch_normalization_primitive_desc_t, batch_normalization);
