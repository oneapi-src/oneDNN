...
conv_fwd_first_x8s8x(const __global uchar *src, const __global char *wei,
...
end_conv_calculate:
    ...
    float4 scales;
    block_read_scales(
            &scales, (group_oc + oc) * OC_BLOCK, sub_local_id, scales_per_oc);
#endif
