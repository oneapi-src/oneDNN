...
status_t xe_hpc_1x1_convolution_fwd_t::pd_t::init_conf(engine_t *engine) {
    ...
    conf.gws_d[0]
            = utils::rnd_up(conf.nchunk * conf.sub_group_size, conf.lws_d[0]);
    ...
    if (is_int8) {
        ...
        wei_tag = conf.with_groups
                ? utils::pick(conf.ndims - 3, format_tag::gOIw2o8i16o4i,
                        format_tag::gOIhw2o8i16o4i)
                : utils::pick(conf.ndims - 3, format_tag::OIw2o8i16o4i,
                        format_tag::OIhw2o8i16o4i);
...
status_t xe_hpc_1x1_convolution_fwd_t::pd_t::init_kernel_ctx(
    ...
    kernel_ctx.define_int("USE_WEI_SLM", 0);
...
status_t xe_hpc_1x1_convolution_fwd_t::execute_forward(
