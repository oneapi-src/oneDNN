...
elemwise_sig((_ref_rnn_common_t<aprop>::rnn_elemwise)) {
    ...
    arg_list.append(workspace.states());
    arg_list.append(workspace.c_states());
    arg_list.append(workspace.gates());
    arg_list.append(workspace.grid_comp());
