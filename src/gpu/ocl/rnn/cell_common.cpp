...
cell_execution_sig((_ref_rnn_common_t<aprop>::cell_execution)) {
    ...
    set_offsets_fwd_rnn_gemm(rnn, iter, dir, lay, src_t, ws_states_offset_,
            cell_ws_iter_offset, cell_ws_lay_offset, &cell_scratch_offset);
    ...
    if (aprop == prop_kind::forward) {
        ...
        gemm_primitive(engine, ctx, wei_iter, wei_iter_offset[0], workspace,
        ...
        set_offsets_bwd_rnn_gemm(rnn, iter, dir, lay, ws_diff_states_offset_,
        ...
        gemm_primitive(engine, ctx, wei_iter, wei_iter_offset[0], scratch_gates,
                cell_scratch_offset, workspace, cell_diff_ws_iter_off,
                gemm_iter_bwd);
