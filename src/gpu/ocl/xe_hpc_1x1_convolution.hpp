...
#ifndef GPU_OCL_XE_HPC_1X1_CONVOLUTION_HPP
#define GPU_OCL_XE_HPC_1X1_CONVOLUTION_HPP
...
struct xe_hpc_1x1_convolution_fwd_t : public gpu_primitive_t {
    struct pd_t : public gpu_convolution_fwd_pd_t {
        pd_t(const convolution_desc_t *adesc, const primitive_attr_t *attr,
                const convolution_fwd_pd_t *hint_fwd_pd)
            : gpu_convolution_fwd_pd_t(adesc, attr, hint_fwd_pd) {}

        DECLARE_COMMON_PD_T("ocl:xe_hpc:1x1", xe_hpc_1x1_convolution_fwd_t);
    ...
    status_t init(engine_t *engine) override {
        const char *kernel_name = "xe_hpc_1x1_conv_fwd";
    ...
    xe_hpc_1x1_convolution_fwd_t(const pd_t *apd) : gpu_primitive_t(apd) {}
