...
#ifndef GPU_SYCL_REF_GEMM_HPP
#define GPU_SYCL_REF_GEMM_HPP
    ...
    struct pd_t : public gpu_gemm_pd_t {
        ...
        status_t init(impl::engine_t *engine) {
            ...
            auto has_runtime_params = has_rt_dims(src_desc)
                    || has_rt_dims(dst_desc) || has_rt_dims(wei_desc);

            if (has_runtime_params) { return status::unimplemented; }
