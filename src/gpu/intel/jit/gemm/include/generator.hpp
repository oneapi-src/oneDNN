...
protected:
    ...
    void calcIncrement(LDIncrements &increments, SubregisterPair &base, int scale, bool isA64, const CommonStrategy &strategy, CommonState &state);
    SubregisterPair lookupIncrement(const LDIncrements &increments, const SubregisterPair &base, int scale, bool isA64, const CommonStrategy &strategy, CommonState &state, bool *release = nullptr);
