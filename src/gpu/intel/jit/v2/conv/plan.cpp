...
private:
    ...
    void init_layouts() {
        ...
        if (desc_.src_tag.is_strided())
            add_stride_reqs(src_layout, tensor_kind_t::src);
        if (desc_.wei_tag.is_strided())
            add_stride_reqs(wei_layout, tensor_kind_t::wei);
        if (desc_.dst_tag.is_strided())
            add_stride_reqs(dst_layout, tensor_kind_t::dst);
    }
