...
bool is_usm_supported(engine_t *engine) {
    ...
    static hrt::ocl::ext_func_t<clSharedMemAllocINTEL_func_t> ext_func(
...
void *malloc_host(engine_t *engine, size_t size) {
    ...
    static hrt::ocl::ext_func_t<clHostMemAllocINTEL_func_t> ext_func(
            "clHostMemAllocINTEL");
    cl_int err;
...
void *malloc_device(engine_t *engine, size_t size) {
    ...
    static hrt::ocl::ext_func_t<clDeviceMemAllocINTEL_func_t> ext_func(
...
void free(engine_t *engine, void *ptr) {
    ...
    if (!ptr) return;
    static hrt::ocl::ext_func_t<clMemFreeINTEL_func_t> ext_func(
            "clMemFreeINTEL");
...
status_t set_kernel_arg_usm(engine_t *engine, cl_kernel kernel, int arg_index,
    ...
    static hrt::ocl::ext_func_t<clSetKernelArgMemPointerINTEL_func_t> ext_func(
            "clSetKernelArgMemPointerINTEL");
    return hrt::ocl::convert_to_dnnl(
...
status_t memcpy(stream_t *stream, void *dst, const void *src, size_t size,
    ...
    static hrt::ocl::ext_func_t<clEnqueueMemcpyINTEL_func_t> ext_func(
...
status_t fill(stream_t *stream, void *ptr, const void *pattern,
    ...
    static hrt::ocl::ext_func_t<clEnqueueMemFillINTEL_func_t> ext_func(
...
ocl_usm_kind_t get_pointer_type(engine_t *engine, const void *ptr) {
    ...
    static hrt::ocl::ext_func_t<clGetMemAllocInfoINTEL_func_t> ext_func(
