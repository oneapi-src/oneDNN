...
const op_kind_t ConvTransposeBackpropData = kConvTransposeBackpropData;
const op_kind_t ConvTransposeBackpropFilters = kConvTransposeBackpropFilters;
...
const op_kind_t HardSwishBackprop = kHardSwishBackprop;
