...
const char *env_names[] = {"SC_CPU_JIT", "SC_TRACE", "SC_DUMP_GRAPH",
        ...
        "SC_BOUNDARY_CHECK", "SC_PRINT_GENCODE", "SC_DUMP_GENCODE",
        "SC_JIT_CC_OPTIONS_GROUP", "SC_CPU_JIT_FLAGS", "SC_VERBOSE",
        "SC_RUN_THREADS", "SC_TRACE_INIT_CAP", "SC_EXECUTION_VERBOSE",
        "SC_LOGGING_FILTER", "SC_HOME", "SC_SSA_PASSES", "SC_PRINT_PASS_TIME",
        "SC_PRINT_PASS_RESULT", "SC_JIT_PROFILE", "SC_MIXED_FUSION",
        "SC_COST_MODEL", "SC_DEBUG_INFO", "SC_PREFETCH",
