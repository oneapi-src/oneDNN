...
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_DYNAMIC_DISPATCH_OP_QUERY_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_DYNAMIC_DISPATCH_OP_QUERY_HPP
...
SC_API void query_format_matmul_core_op(void *table, void *out, void *data,
        ...
        uint64_t *weight_fmt, void *kernel);
SC_API void query_format_unary_fusible_op(void *table, void *out, void *in,
        uint64_t *out_fmt, uint64_t *in_fmt, void *kernel);
