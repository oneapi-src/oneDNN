 ...
 *******************************************************************************/
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_KERNEL_INCLUDE_X86SIMD_VEC_S32X16_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_KERNEL_INCLUDE_X86SIMD_VEC_S32X16_HPP
#include <immintrin.h>
#include <stdint.h>
#include "common.hpp"
...
public:
    ...
    static INLINE void mask_store(int *p, __mmask16 mask, vec_s32x16 &a) {
