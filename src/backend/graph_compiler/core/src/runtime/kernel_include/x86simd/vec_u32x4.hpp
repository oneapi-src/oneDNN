 ...
 *******************************************************************************/
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_KERNEL_INCLUDE_X86SIMD_VEC_U32X4_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_KERNEL_INCLUDE_X86SIMD_VEC_U32X4_HPP
#include <immintrin.h>
#include <stdint.h>
#include "common.hpp"
class vec_u16x4;
...
#ifdef __AVX512F__
    static INLINE void mask_store(uint32_t *p, __mmask8 mask, vec_u32x4 &a) {
