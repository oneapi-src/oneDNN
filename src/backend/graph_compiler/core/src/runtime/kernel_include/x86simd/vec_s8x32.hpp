 ...
 *******************************************************************************/
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_KERNEL_INCLUDE_X86SIMD_VEC_S8X32_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_RUNTIME_KERNEL_INCLUDE_X86SIMD_VEC_S8X32_HPP
#include <immintrin.h>
#include <stdint.h>
#include "common.hpp"
class vec_s8x32 {
...
#ifdef __AVX512F__
    static INLINE void mask_store(int8_t *p, __mmask32 mask, vec_s8x32 &a) {
