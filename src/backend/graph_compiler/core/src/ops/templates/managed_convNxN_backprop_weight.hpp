...
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_OPS_TEMPLATES_MANAGED_CONVNXN_BACKPROP_WEIGHT_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_OPS_TEMPLATES_MANAGED_CONVNXN_BACKPROP_WEIGHT_HPP
...
public:
  ...
  gen_nested_conv_bwd_weight_core_t(sc_op *owner, const sc_dims &stride,
