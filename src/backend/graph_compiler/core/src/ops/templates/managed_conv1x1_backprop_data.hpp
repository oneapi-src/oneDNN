...
struct managed_conv1x1_bwd_data_config_t {
  int BS_split_num;
  int S_split_num;
  int IC_split_num;
  int BS_sub_block;
...
class gen_managed_conv1x1_backprop_data_t
  : public body_generator_t<managed_conv1x1_bwd_data_config_t> {
public:
  // inner most block
  int im_bs_block_;
  int im_ow_block_;
  ...
  using parent = body_generator_t<managed_conv1x1_bwd_data_config_t>;
