...
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_UTIL_REFLECTION_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_UTIL_REFLECTION_HPP
...
const std::type_info *get_rtti_by_type(const type *rtti_data);
