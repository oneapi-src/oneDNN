...
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_JIT_XBYAK_XBYAK_LOWERING_VIEWER_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_JIT_XBYAK_XBYAK_LOWERING_VIEWER_HPP
...
private:
    ...
    void handle_avx_blend(const operand &op_dst, const operand &op_lhs,
            ...
            const x86_64::cpu_data_type &cpu_dtype);
    void handle_avx_zero_mov(const operand &op_dst, const operand &op_src,
