...
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_IR_SEQUENTIAL_FUNCTION_PASS_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_IR_SEQUENTIAL_FUNCTION_PASS_HPP
