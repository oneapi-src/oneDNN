...
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_IR_PASS_IR_COPY_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_IR_PASS_IR_COPY_HPP
...
public:
    ...
    expr_c operator()(const expr_c &v);
    stmt_c operator()(const stmt_c &v);
