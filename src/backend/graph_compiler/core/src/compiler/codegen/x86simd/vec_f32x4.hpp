 ...
 *******************************************************************************/
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_CODEGEN_X86SIMD_VEC_F32X4_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_CODEGEN_X86SIMD_VEC_F32X4_HPP
#include <immintrin.h>
#include <stdint.h>
#include "common.hpp"
class vec_u16x4;
