 ...
 *******************************************************************************/
#ifndef BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_CODEGEN_CPU_INCLUDE_HPP
#define BACKEND_GRAPH_COMPILER_CORE_SRC_COMPILER_CODEGEN_CPU_INCLUDE_HPP
...
#else
// in JIT mode
void *(*sc_global_aligned_alloc_fptr)(size_t sz, size_t align);
#define sc_global_aligned_alloc sc_global_aligned_alloc_fptr
void (*sc_global_aligned_free_fptr)(void *ptr, size_t align);
#define sc_global_aligned_free sc_global_aligned_free_fptr
#endif
