...
using dnnl::impl::graph::gc::any_map_t;
using dnnl::impl::graph::gc::graph_tensor;
using dnnl::impl::graph::gc::graph_tensor_ptr;
using dnnl::impl::graph::gc::sc_data_etype;
using dnnl::impl::graph::gc::sc_data_format_t;
using dnnl::impl::graph::gc::sc_data_type_t;
using dnnl::impl::graph::gc::sc_graph_t;
using dnnl::impl::graph::gc::sc_op_ptr;

class compiler_graph_impl_t : public sc_graph_t {
public:
    compiler_graph_impl_t() = default;

    // convert onednn graph op to compiler backend op
    sc_op_ptr make_backend_op(const op_t *aop,
