...
public:
    ...
    virtual impl::status_t compile(
        ...
        static std::set<op_kind_t> subgraph_patterns {op_kind::int8_conv_relu,
                ...
                op_kind::int8_matmul_bias_add, op_kind::x8s8f32_matmul_add,
                op_kind::x8s8f32_matmul_bias_add, op_kind::x8s8f32_matmul,
                op_kind::x8s8f32_matmul_bias, op_kind::x8s8f32_matmul_relu,
                ...
                op_kind::int8_maxpool, op_kind::x8s8f32_conv_relu,
                op_kind::x8s8f32_conv, op_kind::x8s8f32_conv_bias_relu,
                op_kind::x8s8f32_conv_bias, op_kind::x8s8f32_conv_bias_add_relu,
