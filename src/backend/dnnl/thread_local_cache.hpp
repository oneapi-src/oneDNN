 ...
 *******************************************************************************/
#ifndef BACKEND_DNNL_THREAD_LOCAL_CACHE_HPP
#define BACKEND_DNNL_THREAD_LOCAL_CACHE_HPP
...
// - If users want to desctroy the cached value for a certain key in ALL thread,
