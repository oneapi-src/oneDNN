...
#define DNNL_REGISTER_KERNEL(op_kind_, kernel_class_) \
    ...
    DNNL_REGISTER_KERNEL(
            op_kind::convtranspose_post_ops_fusion, float_convtranspose_fwd)
    ...
    DNNL_REGISTER_KERNEL(impl::op_kind::Clamp, float_eltwise_fwd)
    ...
    DNNL_REGISTER_KERNEL(impl::op_kind::ClampBackprop, eltwise_bwd_t)
    ...
    DNNL_REGISTER_KERNEL(op_kind::pool_post_ops_fusion, float_pooling_fwd)
