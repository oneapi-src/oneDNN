...
#ifndef CUDNN_DECONVOLUTION_IMPL_HPP
#define CUDNN_DECONVOLUTION_IMPL_HPP
...
public:
    ...
    status_t init(deconvolution_pd_t *pd) {
    ...
    void execute_bias(cudnnHandle_t handle, void *y, void *bias) {
...
#endif // CUDNN_DECONVOLUTION_IMPL_HPP
