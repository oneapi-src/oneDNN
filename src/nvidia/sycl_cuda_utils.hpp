...
#ifndef SYCL_CUDA_UTILS_HPP
#define SYCL_CUDA_UTILS_HPP
    ...
    switch (mem_desc->data_type) {
        ...
        case dnnl_data_type_t::dnnl_f32:
            *cudnn_data_type = cudnnDataType_t::CUDNN_DATA_FLOAT;
            ...
            // CUDNN_DATA_UINT8x4. DNNL does not support UINT8 and block size of
            // 32, hence the only valid case is CUDNN_DATA_INT8x4
