...
#ifndef CUDNN_LRN_IMPL_HPP
#define CUDNN_LRN_IMPL_HPP
...
struct cudnn_lrn_fwd_impl_t : public cudnn_lrn_impl_base_t {
    ...
    virtual status_t init(const lrn_pd_t *pd) override {
    ...
    virtual void execute(
            cudnnHandle_t handle, const std::vector<void *> &args) {
