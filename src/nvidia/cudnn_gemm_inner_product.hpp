...
#ifndef CUDNN_GEMM_INNER_PRODUCT_HPP
#define CUDNN_GEMM_INNER_PRODUCT_HPP
...
#include "nvidia/cudnn_gemm_inner_product_impl.hpp"
#include "nvidia/cudnn_inner_product.hpp"
...
struct cudnn_gemm_inner_product_fwd_t : public cudnn_inner_product_fwd_t {
    ...
    struct pd_t : public parrent_pd_t {
        ...
        status_t init(engine_t *engine) {
            ...
            bool need_reorder = (gem_compatible
                            ? false
            ...
            ok = ok
                    ...
                    && (gem_compatible || need_reorder);
            if (!ok) return status::unimplemented;
            inner_product_impl.reset(new cudnn_gemm_inner_product_fwd_impl_t());
            return inner_product_impl->init(engine, this, with_eltwise,
...
struct cudnn_gemm_inner_product_bwd_data_t
    ...
    struct pd_t : public parent_pd_t {
        ...
        status_t init(engine_t *engine) {
            ...
            if (!ok) return status::unimplemented;
            if (has_zero_dim_memory()) return status::success;
            bool gem_compatible = gemm_consitency_check(
            ...
            inner_product_impl.reset(
                    new cudnn_gemm_inner_product_bwd_data_impl_t());

            return inner_product_impl->init(
...
#endif // CUDNN_GEMM_INNER_PRODUCT_HPP
