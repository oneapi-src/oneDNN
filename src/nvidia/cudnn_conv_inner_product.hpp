...
#ifndef CUDNN_CONV_INNER_PRODUCT_HPP
#define CUDNN_CONV_INNER_PRODUCT_HPP
...
#include "nvidia/cudnn_conv_inner_product_impl.hpp"
...
struct cudnn_conv_inner_product_fwd_t : public cudnn_inner_product_fwd_t {
    ...
    struct pd_t : public parent_pd_t {
        ...
        status_t init(engine_t *engine) {
            ...
            inner_product_impl.reset(new cudnn_conv_inner_product_fwd_impl_t());

            auto st = inner_product_impl->init(engine, this, with_relu(),
        ...
        bool blocking_ok(bool with_relu, bool &use_fused_path_for_blocking) {
    ...
    virtual const pd_t *pd() const override {
...
#endif // CUDNN_CONV_INNER_PRODUCT_HPP
