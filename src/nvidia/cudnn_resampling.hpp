...
#ifndef CUDNN_RESAMPLING_HPP
#define CUDNN_RESAMPLING_HPP
...
#include "nvidia/cudnn_resampling_impl.hpp"
...
protected:
    ...
    status_t prepare_coordinate_grid(engine_t *engine, const pd_t *pd) {
        ...
        int ndims = pd->resampling_impl->ndims();
        data_t OW = pd->resampling_impl->dims_[io::dst][ndims - 1],
               IW = pd->resampling_impl->dims_[io::src][ndims - 1],
               OH = pd->resampling_impl->dims_[io::dst][ndims - 2],
               IH = pd->resampling_impl->dims_[io::src][ndims - 2];
        ...
        auto &st_desc_ = pd->resampling_impl->st_desc_;
        ...
        // assume the values are 0, while DNNL uses the boundary values. So we
...
struct cudnn_resampling_fwd_t : public cudnn_resampling_base_t {
    ...
    struct pd_t : public resampling_fwd_pd_t,
        ...
        status_t init(engine_t *engine) {
            ...
            resampling_impl.reset(new cudnn_resampling_fwd_impl_t());
            return resampling_impl->init(this);
        }

        std::shared_ptr<cudnn_resampling_impl_base_t> resampling_impl;
    };
...
struct cudnn_resampling_bwd_t : public cudnn_resampling_base_t {
    ...
    struct pd_t : public resampling_bwd_pd_t,
        ...
        status_t init(engine_t *engine) {
            ...
            resampling_impl.reset(new cudnn_resampling_bwd_impl_t());
            return resampling_impl->init(this);
        }
        std::shared_ptr<cudnn_resampling_impl_base_t> resampling_impl;
    };
