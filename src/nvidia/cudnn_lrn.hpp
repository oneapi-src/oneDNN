...
#ifndef CUDNN_LRN_HPP
#define CUDNN_LRN_HPP
...
#include "nvidia/cudnn_lrn_impl.hpp"
...
struct cudnn_lrn_fwd_t : public primitive_t {
    ...
    struct pd_t : public lrn_fwd_pd_t {
        ...
        pd_t(const lrn_desc_t *adesc, const primitive_attr_t *attr,
            ...
            : lrn_fwd_pd_t(adesc, attr, hint_fwd_pd) {}
        ...
        status_t init(engine_t *) {
            ...
            lrn_impl.reset(new cudnn_lrn_fwd_impl_t());

            return lrn_impl->init(this);
        }
        ...
        std::shared_ptr<cudnn_lrn_impl_base_t> lrn_impl;
    };
...
struct cudnn_lrn_bwd_t : public primitive_t {
    ...
    struct pd_t : public lrn_bwd_pd_t {
        pd_t(const lrn_desc_t *adesc, const primitive_attr_t *attr,
                const lrn_fwd_pd_t *hint_fwd_pd)
            : lrn_bwd_pd_t(adesc, attr, hint_fwd_pd) {}
        ...
        status_t init(engine_t *) {
            ...
            lrn_impl.reset(new cudnn_lrn_bwd_impl_t());
