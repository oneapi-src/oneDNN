...
#ifndef CUDNN_POOLING_IMPL_HPP
#define CUDNN_POOLING_IMPL_HPP
...
struct cudnn_pooling_fwd_impl_t : public cudnn_pooling_impl_base_t {
    virtual status_t init(const pooling_pd_t *pd) override {
...
struct cudnn_pooling_bwd_impl_t : public cudnn_pooling_impl_base_t {
    ...
    virtual void execute(cudnnHandle_t handle, void *dx, void *dy, void *ws_x,
            void *ws_y) const override {
