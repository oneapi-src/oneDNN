...
#ifndef CUDNN_INNER_PRODUCT_IMPL_HPP
#define CUDNN_INNER_PRODUCT_IMPL_HPP
...
struct cudnn_inner_product_impl_base_t {
    ...
    void *output_scale_workspace_ = nullptr;
    ...
    void set_bias_dims(cudnnTensorFormat_t format, int ndims, int bias_dim) {
        ...
        // NCDHW order. The fist dimension of filter must be equal to the
...
#endif // CUDNN_INNER_PRODUCT_IMPL_HPP
