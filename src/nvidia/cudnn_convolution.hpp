...
#ifndef CUDNN_CONVOLUTION_HPP
#define CUDNN_CONVOLUTION_HPP
...
#include "nvidia/cudnn_convolution_impl.hpp"
...
struct cudnn_convolution_fwd_t : public primitive_t {
    ...
    struct pd_t : public cudnn_convolution_fwd_pd_t {
        ...
        bool use_temp_dst_ = attr()->post_ops_.len_ > 0;
    ...
    private:
        ...
        bool check_s8_configuration() {
            auto check_nhwc
                    = [](dnnl_memory_desc_t &md, bool is_weights = false) {
