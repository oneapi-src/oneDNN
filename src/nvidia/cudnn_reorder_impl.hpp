...
#ifndef CUDNN_REORDER_IMPL_HPP
#define CUDNN_REORDER_IMPL_HPP
...
public:
    virtual status_t init(const reorder_pd_t *pd) override {
        ...
        CHECK(CUDNN_EXECUTE_FUNC_S(cudnnSetTensorTransformDescriptor,
                trans_desc_, ndims_, dst_format_, NULL, NULL, NULL,
    ...
    virtual void execute(
            cudnnHandle_t handle, void *src, void *dst) const override {
