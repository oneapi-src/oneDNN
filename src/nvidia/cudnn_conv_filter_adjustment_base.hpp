...
#ifndef CUDNN_CONV_FILTER_ADJUSTMENT_BASE_HPP
#define CUDNN_CONV_FILTER_ADJUSTMENT_BASE_HPP
...
public:
    ...
    void propagate_strides(
            int *strides, const int *dims, std::initializer_list<int> perm) {
        int prev_p = -1;
        for (auto p : perm) {
...
#endif // CUDNN_CONV_FILTER_ADJUSTMENT_BASE_HPP
