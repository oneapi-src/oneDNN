...
#ifndef CUDNN_POOLING_HPP
#define CUDNN_POOLING_HPP

#include "common/c_types_map.hpp"
#include "common/pooling_pd.hpp"
#include "common/primitive.hpp"
#include "common/type_helpers.hpp"
#include "nvidia/cudnn_pooling_impl.hpp"
...
struct cudnn_pooling_common_t {
    ...
    format_tag_t get_tag(const memory_desc_t &md) {
...
struct cudnn_pooling_fwd_t : public primitive_t {
    struct pd_t : public pooling_fwd_pd_t, public cudnn_pooling_common_t {
        pd_t(const pooling_desc_t *adesc, const primitive_attr_t *attr,
            ...
            : pooling_fwd_pd_t::pooling_fwd_pd_t(adesc, attr, hint_fwd_pd) {}
        ...
        status_t init(engine_t *engine) {
            ...
            pooling_impl.reset(new cudnn_pooling_fwd_impl_t());
            return pooling_impl->init(this);
        }
        ...
        std::shared_ptr<cudnn_pooling_impl_base_t> pooling_impl;
    };
...
struct cudnn_pooling_bwd_t : public primitive_t {
    struct pd_t : public pooling_bwd_pd_t, public cudnn_pooling_common_t {
        pd_t(const pooling_desc_t *adesc, const primitive_attr_t *attr,
                const pooling_fwd_pd_t *hint_fwd_pd)
            : pooling_bwd_pd_t(adesc, attr, hint_fwd_pd) {}
        ...
        status_t init(engine_t *engine) {
            ...
            pooling_impl.reset(new cudnn_pooling_bwd_impl_t());
            return pooling_impl->init(this);
        }
