...
#ifndef CUDNN_SOFTMAX_HPP
#define CUDNN_SOFTMAX_HPP
...
#include "nvidia/cudnn_softmax_impl.hpp"
...
struct cudnn_softmax_fwd_t : public primitive_t {
    ...
    struct pd_t : public softmax_fwd_pd_t {
        ...
        status_t init(engine_t *) {
            ...
            softmax_impl.reset(new cudnn_softmax_fwd_impl_t());

            return softmax_impl->init(this);
        }

        std::shared_ptr<cudnn_softmax_impl_base_t> softmax_impl;
    };
...
struct cudnn_softmax_bwd_t : public primitive_t {
    ...
    struct pd_t : public softmax_bwd_pd_t {
        ...
        status_t init(engine_t *) {
            ...
            softmax_impl.reset(new cudnn_softmax_bwd_impl_t());
