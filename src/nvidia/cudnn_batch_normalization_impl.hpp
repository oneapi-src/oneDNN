...
#ifndef CUDNN_BATCH_NORMALIZATION_IMPL_HPP
#define CUDNN_BATCH_NORMALIZATION_IMPL_HPP
...
struct cudnn_batch_normalization_fwd_impl_t
    ...
    virtual status_t init(batch_normalization_pd_t *pd) override {
        init_common(pd);
...
#endif // CUDNN_BATCH_NORMALIZATION_IMPL
