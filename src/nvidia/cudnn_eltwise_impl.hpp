...
#ifndef SYCL_CUDA_ELTWISE_IMPL_HPP
#define SYCL_CUDA_ELTWISE_IMPL_HPP
...
public:
    ...
    status_t convert_alg_kind(
            alg_kind_t alg_kind, cudnnActivationMode_t *cuda_alg_kind) {
        switch (alg_kind) {
...
public:
    virtual status_t init(const eltwise_pd_t *pd) override {
    ...
    virtual void execute(
            cudnnHandle_t handle, void **x, int size) const override {
...
#endif // SYCL_CUDA_ELTWISE_IMPL_HPP
