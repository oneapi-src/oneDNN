...
#ifndef SYCL_CUDA_ELTWISE_HPP
#define SYCL_CUDA_ELTWISE_HPP

#include "common/eltwise_pd.hpp"
#include "common/primitive.hpp"
#include "nvidia/cudnn_eltwise_impl.hpp"
...
struct cudnn_eltwise_fwd_t : public primitive_t {
    ...
    struct pd_t : public eltwise_fwd_pd_t {
        ...
        status_t init(engine_t *) {
            ...
            eltwise_fwd_impl.reset(new cudnn_eltwise_fwd_impl_t());

            return eltwise_fwd_impl->init(this);
        }
        std::shared_ptr<cudnn_eltwise_impl_base_t> eltwise_fwd_impl;
    };
...
struct cudnn_eltwise_bwd_t : public primitive_t {
    ...
    struct pd_t : public eltwise_bwd_pd_t {
        ...
        status_t init(engine_t *) {
            ...
            ;
            if (!ok) return status::unimplemented;
            eltwise_bwd_impl.reset(new cudnn_eltwise_bwd_impl_t());
            return eltwise_bwd_impl->init(this);
        }
        std::shared_ptr<cudnn_eltwise_impl_base_t> eltwise_bwd_impl;
    };
