...
#ifndef CUDNN_BATCH_NORMALIZATION_EXECUTOR_HPP
#define CUDNN_BATCH_NORMALIZATION_EXECUTOR_HPP
...
protected:
    ...
    void interop_task_fwd(
            ...
            cuda::sycl_cuda_stream_t *cuda_stream, read_acc_t src_acc,
    ...
    template <typename T>
    void maybe_init_ss(
            cuda::sycl_cuda_stream_t *cuda_stream, T, T, bool) const {}

    template <typename T>
    void maybe_init_ss(cuda::sycl_cuda_stream_t *cuda_stream,
    ...
    template <typename T>
    void maybe_init_mean_var(cuda::sycl_cuda_stream_t *cuda_stream,
...
#endif // CUDNN_BATCH_NORMALIZATION_EXECUTOR_HPP
