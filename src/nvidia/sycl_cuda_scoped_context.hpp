...
#ifndef SYCL_CUDA_SCOPED_CONTEXT_HPP
#define SYCL_CUDA_SCOPED_CONTEXT_HPP
...
public:
    ...
    inline T memory(cl::sycl::interop_handler ih, U acc) {
...
#endif // SYCL_CUDA_SCOPED_CONTEXT_HPP
