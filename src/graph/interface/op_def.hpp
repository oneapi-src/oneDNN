...
DNNL_GRAPH_OP_SCHEMA(AbsBackward, 1,
        op_schema_t()
                .set_num_inputs(2)
                .set_num_outputs(1)
                .set_input(0, "input_forward", "T")
                .set_input(1, "output_delta", "T")
                .set_output(0, "input_delta", "T")
                .set_type_constraints(
                        "T", {data_type::f32, data_type::bf16, data_type::f16})
                .set_shape_inference_function(infer_identity_output_shape))
...
DNNL_GRAPH_OP_SCHEMA(AvgPoolBackward, 1,
        op_schema_t()
                ...
                .set_num_outputs(1)
                .set_input(0, "output_delta", "T")
                .set_input(1, "input_shape", "T1")
                .set_output(0, "input_delta", "T")
                .set_attr(op_attr::strides, true, attribute_kind::is)
                .set_attr(op_attr::pads_begin, true, attribute_kind::is)
                .set_attr(op_attr::pads_end, true, attribute_kind::is)
...
DNNL_GRAPH_OP_SCHEMA(BatchNormForwardTraining, 1,
        op_schema_t()
                ...
                .set_input(4, "beta", "T2")
                .set_output(0, "output", "T1")
                .set_output(1, "running mean", "T2")
                .set_output(2, "running variance", "T2")
                .set_output(3, "batch mean", "T2")
                .set_output(4, "batch variance", "T2")
                .set_attr(op_attr::epsilon, true, attribute_kind::f)
...
DNNL_GRAPH_OP_SCHEMA(BatchNormTrainingBackward, 1,
        op_schema_t()
                ...
                .set_input(0, "input", "T1")
                .set_input(1, "output_delta", "T1")
                .set_input(2, "mean", "T2")
                .set_input(3, "variance", "T2")
                .set_input(4, "gamma", "T2")
                .set_output(0, "input_delta", "T1")
                .set_output(1, "gamma_delta", "T2")
                .set_output(2, "beta_delta", "T2")
                .set_attr(op_attr::epsilon, true, attribute_kind::f)
                .set_attr(op_attr::data_format, false, attribute_kind::s, "NXC",
                        {"NCX", "NXC"})
                .set_type_constraints(
...
DNNL_GRAPH_OP_SCHEMA(ConvolutionBackwardData, 1,
        op_schema_t()
                ...
                .set_num_outputs(1)
                .set_input(0, "input", "T1")
                .set_input(1, "weight", "T1")
                .set_input(2, "output_shape", "T2")
                .set_output(0, "output", "T1")
...
DNNL_GRAPH_OP_SCHEMA(ConvolutionBackwardWeights, 1,
        op_schema_t()
                ...
                .set_input(0, "input", "T1")
                .set_input(1, "output_delta", "T1")
                .set_input(2, "filter_shape", "T2")
                .set_output(0, "weight_delta", "T1")
...
DNNL_GRAPH_OP_SCHEMA(PReLUBackward, 1,
        op_schema_t()
                ...
                .set_input(0, "input_forward", "T")
                .set_input(1, "slope", "T")
                .set_input(2, "output_delta", "T")
                .set_output(0, "input_delta", "T")
                .set_output(1, "slope_delta", "T")
                .set_attr(op_attr::data_format, false, attribute_kind::s, "NXC",
                        {"NCX", "NXC"})
                .set_type_constraints(
                        "T", {data_type::f32, data_type::bf16, data_type::f16})
...
DNNL_GRAPH_OP_SCHEMA(Wildcard, 1,
        op_schema_t()
                ...
                .set_num_outputs(std::set<size_t>(
                        {0, std::numeric_limits<size_t>::max()}))
                .set_input(0, "input", "any")
                .set_output(0, "output", "any")
