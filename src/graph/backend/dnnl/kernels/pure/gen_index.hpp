...
#ifndef GRAPH_BACKEND_DNNL_KERNELS_GENINDEX_HPP
#define GRAPH_BACKEND_DNNL_KERNELS_GENINDEX_HPP
...
struct genindex_config_t {
public:
    genindex_config_t() = default;
...
private:
    // SDP-related params
    genindex_config_t genindex_cfg_;
