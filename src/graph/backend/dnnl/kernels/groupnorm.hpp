...
#ifndef GRAPH_BACKEND_DNNL_KERNELS_GROUPNORM_HPP
#define GRAPH_BACKEND_DNNL_KERNELS_GROUPNORM_HPP
...
struct groupnorm_fwd_t : public kernel_base_t {
private:
