...
#include "graph/backend/dnnl/kernels/greater_than.hpp"
...
status_t greaterthan_t::compile_impl(const dnnl_partition_impl_t *part,
...
void greaterthan_t::prepare_args_set(const execution_args_set_t *res,
...
status_t greaterthan_t::execute_impl(const stream_t *g_stream,
        const std::vector<tensor_t> &inputs,
...
status_t greaterthan_t::sycl_execute_impl(const stream_t *g_stream,
        const std::vector<tensor_t> &inputs,
        const std::vector<tensor_t> &outputs,
...
status_t greaterthan_t::ocl_execute_impl(const stream_t *g_stream,
        const std::vector<tensor_t> &inputs,
        const std::vector<tensor_t> &outputs,
