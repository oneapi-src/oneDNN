...
template <bool quantized>
void concat_t<quantized>::prepare_args_set(const execution_args_set_t *res,
...
template struct concat_t</* quantized */ false>;
template struct concat_t</* quantized */ true>;
} // namespace dnnl_impl
} // namespace graph
} // namespace impl
} // namespace dnnl
