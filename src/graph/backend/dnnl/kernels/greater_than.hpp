...
#ifndef GRAPH_BACKEND_DNNL_KERNELS_greaterthan_HPP
#define GRAPH_BACKEND_DNNL_KERNELS_greaterthan_HPP
...
struct greaterthan_t : public kernel_base_t {
private:
...
public:
    ...
    DEF_KERNEL_METHOD_STR(greaterthan_t)
    DNNL_DISALLOW_COPY_AND_ASSIGN(greaterthan_t)
};
