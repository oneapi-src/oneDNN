...
#ifndef GRAPH_BACKEND_DNNL_KERNELS_GREATER_EQUAL_HPP
#define GRAPH_BACKEND_DNNL_KERNELS_GREATER_EQUAL_HPP
...
struct greaterequal_t : public kernel_base_t {
private:
...
public:
    ...
    DEF_KERNEL_METHOD_STR(greaterequal_t)
    DNNL_DISALLOW_COPY_AND_ASSIGN(greaterequal_t)
};
