...
DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(
        dnnl, sdp_with_compressed_kv_fusion_cpu)
        .set_priority(22.0f)
        .set_kind(partition_kind_t::quantized_sdp)
        .set_engine_kind(engine_kind::cpu)
        .set_attr<FCreatePattern>("FCreatePattern",
...
DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(
        dnnl, sdp_with_compressed_kv_fusion_gpu)
        .set_priority(22.0f)
        .set_kind(partition_kind_t::quantized_sdp)
        .set_engine_kind(engine_kind::gpu)
        .set_attr<FCreatePattern>("FCreatePattern",
        ...
        .set_attr<FCreateKernel>("FCreateKernel", []() -> kernel_ptr {
            return std::make_shared<sdp_base_t<true>>();
        });

DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(
        dnnl, sdp_with_compressed_v_fusion_cpu)
        .set_priority(22.0f)
        .set_kind(partition_kind_t::quantized_sdp)
        .set_engine_kind(engine_kind::cpu)
        .set_attr<FCreatePattern>("FCreatePattern",
...
DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(
        dnnl, sdp_with_compressed_v_fusion_gpu)
        .set_priority(22.0f)
        .set_kind(partition_kind_t::quantized_sdp)
        .set_engine_kind(engine_kind::gpu)
        .set_attr<FCreatePattern>("FCreatePattern",
...
DNNL_BACKEND_REGISTER_PATTERN_MATCHER_PASS(
        dnnl, sdp_with_compressed_k_fusion_cpu)
        .set_priority(22.0f)
        .set_kind(partition_kind_t::quantized_sdp)
        .set_engine_kind(engine_kind::cpu)
        .set_attr<FCreatePattern>("FCreatePattern",
