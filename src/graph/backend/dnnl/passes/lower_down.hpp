 ...
 *******************************************************************************/
#ifndef GRAPH_BACKEND_DNNL_PASSES_LOWER_DOWN_HPP
#define GRAPH_BACKEND_DNNL_PASSES_LOWER_DOWN_HPP
...
status_t replace_quant_dequant_with_mul_scales(std::shared_ptr<subgraph_t> &sg);
