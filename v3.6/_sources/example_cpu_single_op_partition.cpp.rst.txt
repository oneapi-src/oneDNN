.. index:: pair: example; cpu_single_op_partition.cpp
.. _doxid-cpu_single_op_partition_8cpp-example:

cpu_single_op_partition.cpp
===========================

This is an example to demonstrate how to build a simple op graph and run it on CPU. Annotated version: :ref:`Single op partition on CPU <doxid-graph_cpu_single_op_partition_cpp>`
