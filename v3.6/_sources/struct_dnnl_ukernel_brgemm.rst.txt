...
.. ref-code-block:: cpp
	...
	struct brgemm: public :ref:`dnnl::handle<doxid-structdnnl_1_1handle>`
	{
		...
		void :ref:`set_post_ops<doxid-structdnnl_1_1ukernel_1_1brgemm_1a99c44446d24cb50e8c1c20c11c4d7e4e>`(
			...
			const :ref:`post_ops<doxid-structdnnl_1_1post__ops>`& po = default_post_ops()
			);
		...
		:ref:`pack_type<doxid-namespacednnl_1_1ukernel_1a241c23d0afdf43a79d51ef701a9f7c54>` :ref:`get_B_pack_type<doxid-structdnnl_1_1ukernel_1_1brgemm_1a41509e7835003df7976c59193b6a6f31>`() const;
		...
		void :ref:`execute<doxid-structdnnl_1_1ukernel_1_1brgemm_1ac82753b163696dc573e1e73ae200811d>`(
			const void* A,
			const void* B,
			const std::vector<std::pair<:ref:`memory::dim<doxid-structdnnl_1_1memory_1a6ad818e4699872cc913474fa5f122cd5>`, :ref:`memory::dim<doxid-structdnnl_1_1memory_1a6ad818e4699872cc913474fa5f122cd5>`>>& A_B_offsets,
			void* C,
			void* D,
			void* scratchpad,
			const :ref:`attr_params<doxid-structdnnl_1_1ukernel_1_1attr__params>`& params = default_attr_params()
			) const;
...
.. ref-code-block:: cpp
	...
	:ref:`pack_type<doxid-namespacednnl_1_1ukernel_1a241c23d0afdf43a79d51ef701a9f7c54>` get_B_pack_type() const
...
.. index:: pair: function; execute
.. _doxid-structdnnl_1_1ukernel_1_1brgemm_1ac82753b163696dc573e1e73ae200811d:
