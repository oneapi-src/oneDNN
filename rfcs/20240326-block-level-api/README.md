...
two steps (brgemm::desc and brgemm classes) to avoid jitting
overheads.  This will introduce some overhead for brgemm objects
creation though (potential extra copies upon brgemm constructor call).
