...
/// @example cpu_simple_pattern_default_allocator.c
/// @copybrief cpu_simple_pattern_default_allocator_c
/// > Annotated version: @ref cpu_simple_pattern_default_allocator_c

/// @page cpu_simple_pattern_default_allocator_c A CPU example for conv+relu+conv+relu pattern
///
/// > Example code: @ref cpu_simple_pattern_default_allocator.c
...
int main(int argc, char **argv) {
    ...
    // Step 2: traverse the example graph, convert each op to
    ...
    // Step 3: filter and get partition
    ...
    printf("Step 3: Filter and get partition--------");
    DNNL_GRAPH_CHECK(
