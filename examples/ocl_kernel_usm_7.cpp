...
int main(int argc, char **argv) {
    ...
    using MALLOC = void *(*)(cl_context, cl_device_id, cl_ulong *, size_t,
            cl_uint, cl_int *);
    auto usm_malloc
            = reinterpret_cast<MALLOC>(clGetExtensionFunctionAddressForPlatform(
                    platform[1], "clSharedMemAllocINTEL"));
    void *p = usm_malloc(context, *device, nullptr, usm_size, alignment, &err);
