...
void simple_net_int8() {
    ...
    auto user_weights_memory = memory({{conv_weights_tz}, dt::f32, tag::oihw},
    ...
    auto src_reorder_pd
            = reorder::primitive_desc(cpu_engine, user_src_memory.get_desc(),
    ...
    auto bias_reorder_pd
            = reorder::primitive_desc(cpu_engine, user_bias_memory.get_desc(),
    ...
    auto dst_reorder_pd
            = reorder::primitive_desc(cpu_engine, conv_dst_memory.get_desc(),
