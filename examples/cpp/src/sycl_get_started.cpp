...
///
void sycl_get_started_tutorial(engine::kind engine_kind) {
    ...
    ///
    /// @snippet sycl_get_started.cpp Prepare format for logical tensors 0
    ...
    ///
    /// @snippet sycl_get_started.cpp Prepare format for logical tensors 1
    ...
    fill_buffer<float>(q, relu0_dst_data, product(dst_dims), 0.0f);
    ...
    fill_buffer<float>(q, relu1_dst_data, product(dst1_dims), 0.0f);
    ...
    /// @snippet sycl_get_started.cpp Check results
    //[Check results]
...
int main(int argc, char **argv) {
    ...
    sycl_get_started_tutorial(engine_kind);
    return 0;
}
