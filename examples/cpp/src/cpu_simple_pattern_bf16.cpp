...
int main(int argc, char **argv) {
    ...
    logical_tensor conv0_bias_add_dst_desc {logical_id[4], data_type::bf16, dst_dims, layout_type::strided};

    op conv0_bias_add(1, op::kind::BiasAdd, {conv0_dst_desc, conv0_bias_desc}, {conv0_bias_add_dst_desc}, "conv0_bias_add");

    logical_tensor relu0_dst_desc {logical_id[5], data_type::bf16, dst_dims, layout_type::strided};
    
    op relu0(2, op::kind::ReLU, {conv0_bias_add_dst_desc}, {relu0_dst_desc}, "relu0");

    logical_tensor conv1_weight_desc {logical_id[6], data_type::bf16, weight1_dims, layout_type::strided};
    logical_tensor conv1_bias_desc {logical_id[7], data_type::f32, bias1_dims, layout_type::strided};
    logical_tensor conv1_dst_desc {logical_id[8], data_type::bf16, dst_dims, layout_type::strided};
    ...
    logical_tensor conv1_bias_add_dst_desc {logical_id[9], data_type::bf16, dst_dims, layout_type::strided};

    op conv1_bias_add(4, op::kind::BiasAdd, {conv1_dst_desc, conv1_bias_desc}, {conv1_bias_add_dst_desc}, "conv1_bias_add");

    logical_tensor relu1_dst_desc {logical_id[10], data_type::bf16, dst_dims, layout_type::strided};
    ...
    std::unordered_map<size_t, op::kind> op_id_kind_map {{0, op::kind::Convolution},
        {1, op::kind::BiasAdd}, {2, op::kind::ReLU}, {3, op::kind::Convolution}, {4, op::kind::BiasAdd}, {5, op::kind::ReLU}};
    ...
    /// create a list to store all compiled partitions
