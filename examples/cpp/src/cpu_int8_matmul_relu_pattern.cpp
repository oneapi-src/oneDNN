...
/// @example cpu_int8_matmul_relu_pattern.cpp
/// @copybrief cpu_int8_matmul_relu_pattern_cpp
/// Annotated version: @ref cpu_int8_matmul_relu_pattern_cpp

/// @page cpu_int8_matmul_relu_pattern_cpp CPU example for matmul+relu pattern
///
/// > Example code: @ref cpu_int8_matmul_relu_pattern.cpp
...
int main(int argc, char **argv) {
    ...
    dequant_in1.set_attr<std::vector<int64_t>>("zps", {10, 10, 10});
