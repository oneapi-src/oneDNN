...
/// @example cpu_multithreading_matmul_relu_pattern.cpp
/// @copybrief cpu_multithreading_matmul_relu_pattern_cpp
/// Annotated version: @ref cpu_multithreading_matmul_relu_pattern_cpp

/// @page cpu_multithreading_matmul_relu_pattern_cpp CPU example for multithread matmul+relu pattern
///
/// > Example code: @ref cpu_multithreading_matmul_relu_pattern.cpp
