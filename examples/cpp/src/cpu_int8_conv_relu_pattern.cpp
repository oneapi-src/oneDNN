...
/// @example cpu_int8_conv_relu_pattern.cpp
/// @copybrief cpu_int8_conv_relu_pattern_cpp
/// Annotated version: @ref cpu_int8_conv_relu_pattern_cpp

/// @page cpu_int8_conv_relu_pattern_cpp CPU example for conv+relu pattern
///
/// > Example code: @ref cpu_int8_conv_relu_pattern.cpp
