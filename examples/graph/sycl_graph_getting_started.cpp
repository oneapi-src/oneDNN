...
void sycl_graph_getting_started_tutorial(engine::kind ekind) {
    ...
    // create a sycl memory allocator
    ...
    for (const auto &partition : partitions) {
        if (partition.is_supported()) {
            ...
            std::cout << "sycl_graph_getting_started: unsupported partition. "
