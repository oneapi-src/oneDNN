...
int main() {
    ...
    std::vector<int64_t> reshape1_out_shape {16, 128, 128, 1};
    ...
    std::vector<int64_t> tr1_out_shape {16, 1, 128, 128};
    ...
    transpose_1_op.set_attr<std::vector<int64_t>>(
            op::attr::order, std::vector<int64_t> {0, 3, 2, 1});
    ...
    add_op.add_output(lt_add_out); // output shape is {16,1,128,128}
    ...
    transpose_2_op.set_attr<std::vector<int64_t>>(
            op::attr::order, std::vector<int64_t> {0, 3, 1, 2});
    ...
    std::vector<int64_t> reshape2_out_shape {
            16, 128, 128}; // input shape {16,128,1,128}
