	...
	void simple_net(:ref:`engine::kind <doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind) {
	    ...
	    auto formatted_md
	            = [=](const :ref:`memory::dims <doxid-structdnnl_1_1memory_1afdd20764d58c0b517d5a31276672aeb8>` &dimensions, :ref:`memory::format_tag <doxid-structdnnl_1_1memory_1a8e71077ed6a5f7fb7b3e6e1a5a2ecf3f>` layout) {
	                  return :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>` {{dimensions}, :ref:`dt::f32 <doxid-group__dnnl__api__accumulation__mode_1ggad6b8b3ca2e61b8a9703227f4d58ac215a512dc597be7ae761876315165dc8bd2e>`, layout};
	              };
	    ...
	    auto net_src_memory
	            = :ref:`dnnl::memory <doxid-structdnnl_1_1memory>`({{net_src_dims}, :ref:`dt::f32 <doxid-group__dnnl__api__accumulation__mode_1ggad6b8b3ca2e61b8a9703227f4d58ac215a512dc597be7ae761876315165dc8bd2e>`, tag::tnc}, eng);
	    ...
	    auto user_common_weights_layer_memory = :ref:`dnnl::memory <doxid-structdnnl_1_1memory>`(
	            {common_weights_layer_dims, :ref:`dt::f32 <doxid-group__dnnl__api__accumulation__mode_1ggad6b8b3ca2e61b8a9703227f4d58ac215a512dc597be7ae761876315165dc8bd2e>`, tag::ldigo}, eng);
	    ...
	    auto user_common_weights_iter_memory = :ref:`dnnl::memory <doxid-structdnnl_1_1memory>`(
	            {{common_weights_iter_dims}, :ref:`dt::f32 <doxid-group__dnnl__api__accumulation__mode_1ggad6b8b3ca2e61b8a9703227f4d58ac215a512dc597be7ae761876315165dc8bd2e>`, tag::ldigo}, eng);
	    write_to_dnnl_memory(
	    ...
	    auto user_common_bias_memory
	            = :ref:`dnnl::memory <doxid-structdnnl_1_1memory>`({{common_bias_dims}, :ref:`dt::f32 <doxid-group__dnnl__api__accumulation__mode_1ggad6b8b3ca2e61b8a9703227f4d58ac215a512dc597be7ae761876315165dc8bd2e>`, tag::ldgo}, eng);
	    ...
	    auto user_leftmost_dst_layer_memory
	            = :ref:`dnnl::memory <doxid-structdnnl_1_1memory>`({{leftmost_dst_layer_dims}, :ref:`dt::f32 <doxid-group__dnnl__api__accumulation__mode_1ggad6b8b3ca2e61b8a9703227f4d58ac215a512dc597be7ae761876315165dc8bd2e>`, tag::tnc}, eng);
	    write_to_dnnl_memory(
	    ...
	    auto user_rightmost_dst_layer_memory = :ref:`dnnl::memory <doxid-structdnnl_1_1memory>`(
	            {{rightmost_dst_layer_dims}, :ref:`dt::f32 <doxid-group__dnnl__api__accumulation__mode_1ggad6b8b3ca2e61b8a9703227f4d58ac215a512dc597be7ae761876315165dc8bd2e>`, tag::tnc}, eng);
	    write_to_dnnl_memory(
