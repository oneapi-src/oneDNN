...
.. _doxid-graph_gpu_single_op_partition_cpp:
...
Example code: :ref:`gpu_single_op_partition.cpp <doxid-gpu_single_op_partition_8cpp-example>`
...
.. _doxid-graph_gpu_single_op_partition_cpp_1graph_gpu_single_op_partition_cpp_headers:

Public headers
~~~~~~~~~~~~~~

To start using oneDNN Graph, we must include the :ref:`dnnl_graph.hpp <doxid-dnnl__graph_8hpp_source>` header file in the application. All the C++ APIs reside in namespace ``dnnl::graph``.
...
.. _doxid-graph_gpu_single_op_partition_cpp_1graph_gpu_single_op_partition_cpp_tutorial:

gpu_single_op_partition_tutorial() function
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~



.. _doxid-graph_gpu_single_op_partition_cpp_1graph_gpu_single_op_partition_cpp_get_partition:
...
.. _doxid-graph_gpu_single_op_partition_cpp_1graph_gpu_single_op_partition_cpp_compile:
