...
///     and its description (a memory descriptor). For the CPU aengine or with
...
struct memory : public handle<dnnl_memory_t> {
    ...
    ///     CPU aengine or when USM is used, the data handle is a pointer to
    ///     the actual data. For OpenCL it is a cl_mem.
    ...
    ///     CPU aengine, the data handle is a pointer to the actual data. For
    ///     OpenCL it is a cl_mem.
