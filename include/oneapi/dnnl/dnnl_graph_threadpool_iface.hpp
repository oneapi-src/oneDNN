...
#ifndef ONEAPI_DNNL_DNNL_GRAPH_THREADPOOL_IFACE_HPP
#define ONEAPI_DNNL_DNNL_GRAPH_THREADPOOL_IFACE_HPP
...
struct threadpool_iface {
    ...
    /// If set, parallel_for() returns immediately and oneDNN Graph needs
    /// implement waiting for the submitted closures to finish execution
    /// on its own.
