...
if(graph_tbb_cmake_included)
    return()
endif()
set(graph_tbb_cmake_included true)
...
macro(handle_tbb_target)
    if(TBB_FOUND)
        ...
        unset(_tbb_root)
    elseif(DNNL_GRAPH_CPU_RUNTIME STREQUAL "NONE")
        message(FATAL_ERROR "For GPU only SYCL configuration TBB is required for testing.")
    else()
        message(FATAL_ERROR "DNNL_GRAPH_CPU_THREADING_RUNTIME is ${DNNL_GRAPH_CPU_THREADING_RUNTIME} but TBB is not found.")
    endif()
...
if(NOT DNNL_GRAPH_CPU_THREADING_RUNTIME STREQUAL "TBB")
    return()
endif()
