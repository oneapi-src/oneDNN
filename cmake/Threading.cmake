...
if(graph_threading_cmake_included)
    return()
endif()
set(graph_threading_cmake_included true)
...
if(DNNL_GRAPH_CPU_RUNTIME STREQUAL "NONE")
    set(DNNL_GRAPH_CPU_THREADING_RUNTIME "SEQ")
elseif(DNNL_GRAPH_CPU_SYCL)
    set(DNNL_GRAPH_CPU_THREADING_RUNTIME "TBB")
else()
    set(DNNL_GRAPH_CPU_THREADING_RUNTIME "${DNNL_GRAPH_CPU_RUNTIME}")
endif()
