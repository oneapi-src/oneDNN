.. index:: pair: example; sycl_single_op_partition.cpp
.. _doxid-sycl_single_op_partition_8cpp-example:

sycl_single_op_partition.cpp
============================

This is an example to demonstrate how to build a simple op graph and run it on gpu. Annotated version: :ref:`Single op partition on GPU <doxid-graph_sycl_single_op_partition_cpp>`
