...
.. _doxid-group__dnnl__api__ukernel__brgemm_1gafb61d03fbaf27e4edda6805c4b9f47f8:
...
.. list-table::
	...
	*
		...
		- Output packing type. Can be ``dnnl_brgemm_no_trans`` if packing is not expected, and ``dnnl_pack_type_pack32``, otherwise.
