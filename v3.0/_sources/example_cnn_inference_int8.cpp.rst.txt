...
.. ref-code-block:: cpp
	...
	*******************************************************************************/
	...
	void simple_net_int8(:ref:`engine::kind <doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind) {
	    ...
	    //[Allocate buffers]
	    auto user_src_memory = :ref:`memory <doxid-structdnnl_1_1memory>`({{conv_src_tz}, dt::f32, tag::nchw}, eng);
	    ...
	    auto user_bias_memory = :ref:`memory <doxid-structdnnl_1_1memory>`({{conv_bias_tz}, dt::f32, tag::x}, eng);
	    ...
	    // Prepare dst scales
	    auto dst_scale_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({1}, dt::f32, tag::x);
	    ...
	    auto src_scale_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({1}, dt::f32, tag::x);
	    ...
	    auto wei_scale_md = :ref:`memory::desc <doxid-structdnnl_1_1memory_1_1desc>`({1}, dt::f32, tag::x);
	    ...
	    auto user_dst_memory = :ref:`memory <doxid-structdnnl_1_1memory>`({{conv_dst_tz}, dt::f32, tag::nchw}, eng);
