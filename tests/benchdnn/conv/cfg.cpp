...
const _dt_conf_t conf_bf16bf16f32 = {
    {mkldnn_bf16, -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 0.},
    {mkldnn_bf16, -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 0.},
    {mkldnn_f32,  -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 0.},
    {mkldnn_f32,  -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 0.},
    {mkldnn_f32,},
};
...
const _dt_conf_t conf_bf16bf16bf16 = {
    ...
    {mkldnn_bf16, -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 1e-2},
    {mkldnn_bf16, -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 1e-2},
    {mkldnn_f32,  -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 1e-2},
    {mkldnn_bf16, -int_max_exact, int_max_exact, -32,  64, 0, 1, .25, 1e-2},
    {mkldnn_f32,},
};
...
const _dt_conf_t conf_s32s16s16s32 = {
    {mkldnn_s32, INT32_MIN, INT32_MAX, -4,  4, 0, 1, .25, 0.},
    {mkldnn_s16, INT16_MIN, INT16_MAX, -5,  5, 0, 1, .25, 0.},
    {mkldnn_s32, INT32_MIN, INT32_MAX, -8, 32, 0, 1, .25, 0.},
    {mkldnn_s16, INT16_MIN, INT16_MAX, -4,  4, 0, 1, .25, 0.},
...
const _dt_conf_t conf_s16s32s16s32 = {
    {mkldnn_s16, INT16_MIN, INT16_MAX, -5,  5, 0, 1, .25, 0.},
    {mkldnn_s32, INT32_MIN, INT32_MAX, -4,  4, 0, 1, .25, 0.},
    {mkldnn_s32, INT32_MIN, INT32_MAX, -8, 32, 0, 1, .25, 0.},
    {mkldnn_s16, INT16_MIN, INT16_MAX, -4,  4, 0, 1, .25, 0.},
