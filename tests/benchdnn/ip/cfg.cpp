...
const _dt_conf_t conf_bf16bf16f32 = {
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -64,  64, 0, .35, 1./128, 0},
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -128,  128, 0, 1.0, 1./256, 0},
    {mkldnn_f32, -int_max_exact, int_max_exact,  -10,  10, 0, 1.0, 1./64, 0},
    {mkldnn_f32, -int_max_exact, int_max_exact,  -10,  10, 0, .35, 1./64, 1e-6},
    {mkldnn_f32,},
};
...
const _dt_conf_t conf_bf16bf16bf16 = {
    ...
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -64,  64, 0, .35, 1./128, 1e-2},
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -128,  128, 0, 1.0, 1./256, 1e-2},
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -10,  10, 0, 1.0, 1./64, 1e-2},
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -10,  10, 0, .35, 1./64, 1e-2},
    {mkldnn_f32,},
};
...
const _dt_conf_t conf_f32bf16bf16 = {
    {mkldnn_f32, -int_max_exact, int_max_exact,  -64,  64, 0, .35, 1./128, 1e-6},
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -128,  128, 0, 1.0, 1./256, 0},
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -10,  10, 0, 1.0, 1./64, 0},
    {mkldnn_bf16, -int_max_exact, int_max_exact,  -10,  10, 0, .35, 1./64, 0},
    {mkldnn_f32,},
};
...
const _dt_conf_t conf_f16 = {
    {mkldnn_f16, -int_max_exact_half, int_max_exact_half,  -4,  4, 0, .35, 1, 0.},
    {mkldnn_f16, -int_max_exact_half, int_max_exact_half,  -2,  2, 0, .35, 1, 0.},
    {mkldnn_f16, -int_max_exact_half, int_max_exact_half, -8, 8, 0, .35, 1, 0.},
    {mkldnn_f16, -int_max_exact_half, int_max_exact_half,  -4,  4, 0, .35, 1, 0.},
    {mkldnn_f16,},
};
