...
CPU_INST_TEST_CASE(TestGEMM_general_cases_fix_offset,
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, fix_use_oc, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, fix_use_all_offsets, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, fix_no_offsets, false}
);
...
CPU_INST_TEST_CASE(TestGEMM_general_cases_col_offset,
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, col_use_oc, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, col_use_all_offsets, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, col_no_offsets, false}
);
...
CPU_INST_TEST_CASE(TestGEMM_general_cases_row_offset,
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, row_use_oc, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, row_use_all_offsets, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.0, 2.0, 10000, 2, 2, row_no_offsets, false}
);
...
CPU_INST_TEST_CASE(TestGEMM_fractional_scales_fix_offset,
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, fix_use_oc, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, fix_use_all_offsets, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, fix_no_offsets, false}
);
...
CPU_INST_TEST_CASE(TestGEMM_fractional_scales_col_offset,
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, col_use_oc, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, col_use_all_offsets, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, col_no_offsets, false}
);
...
CPU_INST_TEST_CASE(TestGEMM_fractional_scales_row_offset,
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, row_use_oc, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, row_use_all_offsets, false},
    ...
    test_params{'n', 'n', 2, 2, 10000, 1.66f, 2.33f, 10000, 2, 2, row_no_offsets, false}
);


CPU_INST_TEST_CASE(TestGEMV,
    test_params{'n', 'n', 2000, 1, 1000, 1.0f, 0.0f, 1000, 1, 1, fix_no_offsets, false},
    test_params{'n', 'n', 1, 3000, 2000, 1.0f, 0.0f, 2000, 3000, 3000, fix_no_offsets, false},
    test_params{'t', 'n', 2000, 1, 1000, 1.0f, 0.0f, 2000, 1, 1, fix_no_offsets, false},
    test_params{'t', 'n', 1, 3000, 2000, 1.0f, 0.0f, 1, 3000, 3000, fix_no_offsets, false},
    test_params{'n', 't', 2000, 1, 1000, 1.0f, 0.0f, 1000, 1000, 1, fix_no_offsets, false},
    test_params{'n', 't', 1, 3000, 2000, 1.0f, 0.0f, 2000, 2000, 3000, fix_no_offsets, false},
    test_params{'t', 't', 2000, 1, 1000, 1.0f, 0.0f, 2000, 1000, 1, fix_no_offsets, false},
    test_params{'t', 't', 1, 3000, 2000, 1.0f, 0.0f, 1, 2000, 3000, fix_no_offsets, false},

    test_params{'n', 'n', 2000, 1, 1000, 1.0f, 1.0f, 1000, 1, 1, fix_no_offsets, false},
    test_params{'n', 'n', 1, 3000, 2000, 1.0f, 1.0f, 2000, 3000, 3000, fix_no_offsets, false},
    test_params{'t', 'n', 2000, 1, 1000, 1.0f, 1.0f, 2000, 1, 1, fix_no_offsets, false},
    test_params{'t', 'n', 1, 3000, 2000, 1.0f, 1.0f, 1, 3000, 3000, fix_no_offsets, false},
    test_params{'n', 't', 2000, 1, 1000, 1.0f, 1.0f, 1000, 1000, 1, fix_no_offsets, false},
    test_params{'n', 't', 1, 3000, 2000, 1.0f, 1.0f, 2000, 2000, 3000, fix_no_offsets, false},
    test_params{'t', 't', 2000, 1, 1000, 1.0f, 1.0f, 2000, 1000, 1, fix_no_offsets, false},
    test_params{'t', 't', 1, 3000, 2000, 1.0f, 1.0f, 1, 2000, 3000, fix_no_offsets, false}
);

CPU_INST_TEST_CASE(TestGEMV_kblocking,
    test_params{'t', 'n',  20, 1, 7000, 1.0f, 0.0f,  20,    1, 500, fix_no_offsets, false},
    test_params{'t', 't',  50, 1, 7000, 1.0f, 0.0f,  50, 7000, 500, fix_no_offsets, false},
    test_params{'t', 'n', 400, 1, 7000, 1.0f, 0.0f, 400,    1, 500, fix_no_offsets, false},
    test_params{'t', 't', 500, 1, 7000, 1.0f, 0.0f, 500, 7000, 500, fix_no_offsets, false},
    test_params{'t', 'n',  20, 1, 7000, 1.0f, 1.0f,  20,    1, 500, fix_no_offsets, false},
    test_params{'t', 't',  50, 1, 7000, 1.0f, 1.0f,  50, 7000, 500, fix_no_offsets, false},
    test_params{'t', 'n', 500, 1, 7000, 1.0f, 1.0f, 500,    1, 500, fix_no_offsets, false},
    test_params{'t', 't', 500, 1, 7000, 1.0f, 1.0f, 500, 7000, 500, fix_no_offsets, false},

    test_params{'n', 'n', 1,  40, 7000, 1.0f, 0.0f, 7000,   40, 500, fix_no_offsets, false},
    test_params{'t', 'n', 1,  10, 7000, 1.0f, 0.0f, 7000,   10,  10, fix_no_offsets, false},
    test_params{'n', 'n', 1, 400, 7000, 1.0f, 0.0f, 7000,  400, 500, fix_no_offsets, false},
    test_params{'t', 'n', 1, 100, 7000, 1.0f, 0.0f, 7000,  100, 500, fix_no_offsets, false},
    test_params{'n', 'n', 1,  40, 7000, 1.0f, 1.0f, 7000,   40, 500, fix_no_offsets, false},
    test_params{'t', 'n', 1,  10, 7000, 1.0f, 1.0f, 7000,   10, 500, fix_no_offsets, false},
    test_params{'n', 'n', 1, 400, 7000, 1.0f, 1.0f, 7000,  400, 500, fix_no_offsets, false},
    test_params{'t', 'n', 1, 550, 7000, 1.0f, 1.0f, 7000,  550, 550, fix_no_offsets, false}
);
