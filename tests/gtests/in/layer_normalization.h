...
CPU_INST_TEST_CASE(Simple_TNC,
    PARAMS_TNC({6, 32, 8}),
    PARAMS_TNC({2, 10, 4}),
    PARAMS_TNC({2, 8, 16})
);

CPU_INST_TEST_CASE(CrossCase_TNC,
    PARAMS_TNC_CROSS_CASE({6, 32, 8}),
    PARAMS_TNC_CROSS_CASE({2, 10, 4}),
    PARAMS_TNC_CROSS_CASE({2, 8, 16})
);

CPU_INST_TEST_CASE(Simple_NTC,
    PARAMS_TNC({64, 32, 8}),
    PARAMS_TNC({32, 10, 4}),
    PARAMS_TNC({12, 8, 16})
);

CPU_INST_TEST_CASE(Simple_LDSNC,
    PARAMS_LDSNC({6, 2, 2, 32, 8}),
    PARAMS_LDSNC({2, 2, 2, 10, 4}),
    PARAMS_LDSNC({2, 2, 2, 8, 16})
);

CPU_INST_TEST_CASE(CrossCase_LDSNC,
    PARAMS_LDSNC_CROSS_CASE({6, 2, 2, 32, 8}),
