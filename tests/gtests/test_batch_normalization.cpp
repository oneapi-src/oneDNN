...
protected:
    virtual void SetUp()
    {
        ...
        auto bn_scaleshift_desc = create_md({ 2, bnd.c }, prec, p.scaleshift_format);
...
INSTANTIATE_TEST_CASE_P(TestBNormForward, bnorm_test_float,
        ::testing::Values(
            ...
            engine::kind::cpu, memory::format::nchw, memory::format::nchw, memory::format::nc,
            { 2, 10, 4, 4, 1.0e-4} }));
...
INSTANTIATE_TEST_CASE_P(TestBNormGoogleNetForwardNCHW, bnorm_test_float,
        ::testing::Values(
            ...
            memory::format::nc, { 2, 64, 112, 112, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 64, 56, 56, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 192, 56, 56, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 96, 28, 28, 0.1 } },
           bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 16, 28, 28, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 64, 28, 28, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 128, 28, 28, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 32, 28, 28, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 96, 28, 28, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 96, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 16, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 192, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 208, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 48, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 64, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 112, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 24, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 160, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 224, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 128, 4, 4, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 128, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 512, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 256, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 144, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 32, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 228, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 528, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 320, 14, 14, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 160, 7, 7, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 32, 7, 7, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 256, 7, 7, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 320, 7, 7, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 128, 7, 7, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 192, 7, 7, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 48, 7, 7, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 384, 7, 7, 0.1 } }));
INSTANTIATE_TEST_CASE_P(
