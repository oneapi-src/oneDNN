...
INSTANTIATE_TEST_CASE_P(TestBNormGoogleNetForwardNCHW, bnorm_test_float,
        ::testing::Values(
            ...
            memory::format::nc, { 2, 112, 112, 64, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 56, 56, 64, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 56, 56, 192, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 28, 28, 96, 0.1 } },
           bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 28, 28, 16, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 28, 28, 64, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 28, 28, 128, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 28, 28, 32, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 28, 28, 96, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 96, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 16, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 192, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 208, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 48, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 64, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 112, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 24, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 160, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 224, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 4, 4, 128, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 128, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 512, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 256, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 144, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 32, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 228, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 528, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 14, 14, 320, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 160, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 32, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 256, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 320, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 128, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 192, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 48, 0.1 } },
            bnorm_test_params_float{ prop_kind::forward_training,
            engine::kind::cpu, memory::format::nchw, memory::format::nchw,
            memory::format::nc, { 2, 7, 7, 384, 0.1 } }));
}
