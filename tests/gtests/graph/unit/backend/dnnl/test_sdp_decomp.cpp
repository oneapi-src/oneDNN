...
// TEST(test_sdp_decomp_execute, F32DistilBertSdpCorr_CPU_without_broadcast) {
//     graph::engine_t *eng = get_engine();
//     graph::stream_t *strm = get_stream();
...
// TEST(test_sdp_decomp_execute, Bf16DistilBertSdpCorr_CPU_without_broadcast) {
//     graph::engine_t *eng = get_engine();
//     graph::stream_t *strm = get_stream();
...
//         graph::graph_t g(eng->kind());
//         utils::construct_select_float_MHA_without_broadcast(&g,
//                 dnnl::impl::data_type::bf16, batch_size, seq_len, num_head,
//                 head_dim, transpose_b[i]);
//         g.finalize();
...
// TEST(test_sdp_decomp_execute, Int8DistilBertSdpCorr_CPU_without_broadcast) {
//     // for sdp decompose test
//     graph::engine_t *eng = get_engine();
//     graph::stream_t *strm = get_stream();
...
// TEST(test_sdp_decomp_execute, Int8Bf16DistilBertSdpCorr_CPU_without_broadcast) {
//     // for sdp decompose test
//     graph::engine_t *eng = get_engine();
//     graph::stream_t *strm = get_stream();
...
//     for (size_t i = 0; i < KEY_STRIDES.size(); ++i) {
//         graph::graph_t g(eng->kind());
//         utils::construct_int8_bf16_MHA_without_broadcast(&g, batch_size,
//                 seq_len, num_head, head_dim, transpose_b[i], false, true);
//         g.finalize();
