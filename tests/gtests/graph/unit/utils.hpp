...
inline void construct_select_float_MHA_nonBroadcast(
    ...
    dims CONST_SHAPE = {batch_size, num_head, seq_len, seq_len};
...
inline void construct_select_int8_MHA_nonBroadcast(
...
inline void construct_int8_bf16_MHA_nonBroadcast(
        dnnl::impl::graph::graph_t *agraph, int batch_size = 1,
        int seq_len = 384, int num_head = 16, int head_dim = 1024,
    ...
    if (!distil && !gpt)
        ...
        construct_select_int8_MHA_nonBroadcast(agraph, batch_size, seq_len,
