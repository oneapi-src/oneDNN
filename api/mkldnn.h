...
mkldnn_status_t mkldnn_primitive_destroy(mkldnn_primitive_t primitive);
...
mkldnn_primitive_at_t mkldnn_primitive_at(const_mkldnn_primitive_t primitive,
        size_t output_index);
...
mkldnn_status_t mkldnn_tensor_desc_init(mkldnn_tensor_desc_t *tensor_desc,
...
mkldnn_status_t mkldnn_memory_desc_init(mkldnn_memory_desc_t *memory_desc,
 ...
 * inconsistent, the function returns zero. */
size_t mkldnn_memory_desc_get_size(const mkldnn_memory_desc_t *memory_desc);
...
mkldnn_status_t mkldnn_memory_primitive_desc_init(
...
mkldnn_status_t mkldnn_memory_create(mkldnn_primitive_t *memory,
 ...
 * primitive. */
mkldnn_status_t mkldnn_memory_get_primitive_desc(
...
mkldnn_status_t mkldnn_reorder_primitive_desc_init(
...
mkldnn_status_t mkldnn_reorder_create(mkldnn_primitive_t *reorder,
 ...
 * primitive. */
mkldnn_status_t mkldnn_reorder_get_primitive_desc(
...
mkldnn_status_t mkldnn_convolution_desc_init(
 ...
 * engine. */
mkldnn_status_t mkldnn_convolution_primitive_desc_init(
...
mkldnn_status_t mkldnn_convolution_create(mkldnn_primitive_t *convolution,
...
mkldnn_status_t mkldnn_convolution_get_primitive_desc(
...
mkldnn_status_t mkldnn_pooling_desc_init(
 ...
 */
mkldnn_status_t mkldnn_pooling_primitive_desc_init(
...
mkldnn_status_t mkldnn_pooling_create(mkldnn_primitive_t *pooling,
 ...
 * primitive. */
mkldnn_status_t mkldnn_pooling_get_primitive_desc(
...
mkldnn_status_t mkldnn_lrn_desc_init(mkldnn_lrn_desc_t *lrn_desc,
        mkldnn_prop_kind_t prop_kind, mkldnn_alg_kind_t alg_kind,
        const mkldnn_memory_desc_t *src_desc,
...
mkldnn_status_t mkldnn_lrn_primitive_desc_init(
...
mkldnn_status_t mkldnn_lrn_create(mkldnn_primitive_t *lrn,
...
mkldnn_status_t mkldnn_lrn_get_primitive_desc(const_mkldnn_primitive_t lrn,
        mkldnn_lrn_primitive_desc_t *lrn_primitive_desc);
...
mkldnn_status_t mkldnn_inner_product_desc_init(
 ...
 * @p engine. */
mkldnn_status_t mkldnn_inner_product_primitive_desc_init(
...
mkldnn_status_t mkldnn_inner_product_create(
...
mkldnn_status_t mkldnn_inner_product_get_primitive_desc(
...
size_t mkldnn_engine_get_count(mkldnn_engine_kind_t kind);

/** Creates an @p engine of particular @p kind and @p index. */
mkldnn_status_t mkldnn_engine_create(mkldnn_engine_t *engine,
        mkldnn_engine_kind_t kind, size_t index);

/** Returns the kind of an @p engine. */
mkldnn_status_t mkldnn_engine_get_kind(mkldnn_engine_t engine,
        mkldnn_engine_kind_t *kind);

/** Checks whether an @p engine is lazy. */
mkldnn_status_t mkldnn_engine_get_is_lazy(mkldnn_engine_t engine,
        int *is_lazy);

/** Destroys an @p engine. */
mkldnn_status_t mkldnn_engine_destroy(mkldnn_engine_t engine);
...
mkldnn_status_t mkldnn_stream_create(mkldnn_stream_t *stream);
...
mkldnn_status_t mkldnn_stream_submit(mkldnn_stream_t stream, size_t n,
 ...
 * the offending @p error_primitive if it is not @c NULL. */
mkldnn_status_t mkldnn_stream_wait(mkldnn_stream_t stream, int block,
        mkldnn_primitive_t *error_primitive);

/** Destroys an execution @p stream. */
mkldnn_status_t mkldnn_stream_destroy(mkldnn_stream_t stream);
