...
/** Creates a @p primitive using a @p primitive descriptor and array of @p
 ...
 * means do not specify any specific data layout. */
...
/** Creates a @p memory with a @p memory_primitive_desc and @p data_ptr. If @p
 * data_ptr is NULL @p memory would be initialized with internally allocated
 * memory. primitive_destroy() will takes care on allocated memory then. */
 ...
 * this case convolution_primitive_desc_init() will choose the best convolution
...
/** Retrieves the @p convolution_primitive_desc associated with a @p
 ...
 * descriptors, @p strides, @p padding and @p padding_kind.  Please note that
 * memory descriptors may be initialized with format_kind_any format_kind. In
 * this case pooling_primitive_desc_init() will choose the best pooling
 * possible in terms of performance. */
 ...
 * format_kind_any format_kind. In this case
 * inner_product_primitive_desc_init() will choose the best inner product
 * possible in terms of performance. */
...
/** Submits @p n @p primitives to execution @p stream.  All or none of the
 * primitives must be lazy. In case of an error, may return offending @p
 * error_primitive if it is not NULL. */
