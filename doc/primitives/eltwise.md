...
| hardsigmoid  | #dnnl_eltwise_hardsigmoid                                          | \f$ d = \begin{cases} 1 & \text{if}\ s > 3 \\ \frac{s + 3}{6} & \text{if}\ -3 < s \leq 3 \\ 0 & \text{otherwise} \end{cases} \f$                            | \f$ ds = \begin{cases} \frac{dd}{6} & \text{if}\ -3 < s \leq 3 \\ 0 & \text{otherwise}\ \end{cases} \f$                                      | --                                                                                                                     |
...
* \f$ hardswish(s) = s \cdot hardsigmoid(s) \f$
