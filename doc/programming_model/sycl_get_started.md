...
[sycl_get_started.cpp](../../tests/demo/src/sycl_get_started.cpp).
...
code](../../tests/demo/src/sycl_get_started.cpp#L141) for details.
...
Then by calling
[`get_partitions()`](../../include/oneapi/dnnl/dnnl_graph.hpp#L1272), users can
